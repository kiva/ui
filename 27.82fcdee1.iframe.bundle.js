...
// load the styles
var content = __webpack_require__(5784);
...
var KvLoadingPlaceholder = __webpack_require__(43);

// EXTERNAL MODULE: ./node_modules/@kiva/kv-components/vue/KvTextLink.vue + 4 modules
var KvTextLink = __webpack_require__(180);
...
/* harmony default export */ var CreditSummaryLightboxvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      loading: true,
      loadingPromise: null,
      mdiFileDocumentOutline: mdi["w" /* mdiFileDocumentOutline */],
      showLightbox: false,
      // Deposits
    ...
    fetchAsyncData: function fetchAsyncData() {
      ...
      if (this.loading && !this.loadingPromise) {
        this.loadingPromise = this.apollo.query({
          query: Object(lib["gql"])(_templateObject || (_templateObject = taggedTemplateLiteral_default()(["query creditSummary {\n\t\t\t\t\t\tmy {\n\t\t\t\t\t\t\tid\n\t\t\t\t\t\t\tamountDonated\n\t\t\t\t\t\t\tamountWithdrawn\n\t\t\t\t\t\t\tamountDepositedByKiva\n\t\t\t\t\t\t\tcurrencyGainsAmount\n\t\t\t\t\t\t\tcurrencyLossesAmount\n\t\t\t\t\t\t\tdefaultLossesAmount\n\t\t\t\t\t\t\toutstandingPromoCreditAmount\n\t\t\t\t\t\t\tkivaCardsCanceledAmount\n\t\t\t\t\t\t\tkivaCardsPurchasedAmount\n\t\t\t\t\t\t\tkivaCardsRedeemedAmount\n\t\t\t\t\t\t\tlendingStats {\n\t\t\t\t\t\t\t\tid\n\t\t\t\t\t\t\t\ttotalAmountDeposited\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\tuserAccount {\n\t\t\t\t\t\t\t\tid\n\t\t\t\t\t\t\t\tbalance\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\tuserStats {\n\t\t\t\t\t\t\t\tamount_outstanding\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t}\n\t\t\t\t\t}"])))
        }).then(function (_ref3) {
          var _data$my, _data$my2, _data$my3, _data$my4, _data$my5, _data$my6, _data$my7, _data$my8, _data$my9, _data$my10, _data$my11, _data$my12, _data$my13;
          var data = _ref3.data;
          _this.loading = false;
          _this.totalAmountDeposited = CreditSummaryLightboxvue_type_script_lang_js_asNumber(data === null || data === void 0 || (_data$my = data.my) === null || _data$my === void 0 || (_data$my = _data$my.lendingStats) === null || _data$my === void 0 ? void 0 : _data$my.totalAmountDeposited);
          _this.amountDepositedByKiva = CreditSummaryLightboxvue_type_script_lang_js_asNumber(data === null || data === void 0 || (_data$my2 = data.my) === null || _data$my2 === void 0 ? void 0 : _data$my2.amountDepositedByKiva);
          _this.kivaCardsRedeemedAmount = CreditSummaryLightboxvue_type_script_lang_js_asNumber(data === null || data === void 0 || (_data$my3 = data.my) === null || _data$my3 === void 0 ? void 0 : _data$my3.kivaCardsRedeemedAmount);
          _this.kivaCardsCanceledAmount = CreditSummaryLightboxvue_type_script_lang_js_asNumber(data === null || data === void 0 || (_data$my4 = data.my) === null || _data$my4 === void 0 ? void 0 : _data$my4.kivaCardsCanceledAmount);
          _this.currencyGainsAmount = CreditSummaryLightboxvue_type_script_lang_js_asNumber(data === null || data === void 0 || (_data$my5 = data.my) === null || _data$my5 === void 0 ? void 0 : _data$my5.currencyGainsAmount);
          _this.amountDonated = CreditSummaryLightboxvue_type_script_lang_js_asNumber(data === null || data === void 0 || (_data$my6 = data.my) === null || _data$my6 === void 0 ? void 0 : _data$my6.amountDonated);
          _this.currencyLossesAmount = CreditSummaryLightboxvue_type_script_lang_js_asNumber(data === null || data === void 0 || (_data$my7 = data.my) === null || _data$my7 === void 0 ? void 0 : _data$my7.currencyLossesAmount);
          _this.defaultLossesAmount = CreditSummaryLightboxvue_type_script_lang_js_asNumber(data === null || data === void 0 || (_data$my8 = data.my) === null || _data$my8 === void 0 ? void 0 : _data$my8.defaultLossesAmount) * -1;
          _this.kivaCardsPurchasedAmount = CreditSummaryLightboxvue_type_script_lang_js_asNumber(data === null || data === void 0 || (_data$my9 = data.my) === null || _data$my9 === void 0 ? void 0 : _data$my9.kivaCardsPurchasedAmount);
          _this.amountWithdrawn = CreditSummaryLightboxvue_type_script_lang_js_asNumber(data === null || data === void 0 || (_data$my10 = data.my) === null || _data$my10 === void 0 ? void 0 : _data$my10.amountWithdrawn);
          _this.kivaCredit = CreditSummaryLightboxvue_type_script_lang_js_asNumber(data === null || data === void 0 || (_data$my11 = data.my) === null || _data$my11 === void 0 || (_data$my11 = _data$my11.userAccount) === null || _data$my11 === void 0 ? void 0 : _data$my11.balance);
          _this.amountOutstanding = CreditSummaryLightboxvue_type_script_lang_js_asNumber(data === null || data === void 0 || (_data$my12 = data.my) === null || _data$my12 === void 0 || (_data$my12 = _data$my12.userStats) === null || _data$my12 === void 0 ? void 0 : _data$my12.amount_outstanding);
          _this.promoOutstanding = CreditSummaryLightboxvue_type_script_lang_js_asNumber(data === null || data === void 0 || (_data$my13 = data.my) === null || _data$my13 === void 0 ? void 0 : _data$my13.outstandingPromoCreditAmount);
        }).finally(function () {
...
var CreditSummaryLightboxvue_type_style_index_0_id_6458db80_lang_postcss_scoped_true_ = __webpack_require__(5783);
