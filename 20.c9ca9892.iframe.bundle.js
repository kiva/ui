...
// load the styles
var content = __webpack_require__(5707);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
...
var comparators = __webpack_require__(414);

// EXTERNAL MODULE: ./src/graphql/query/lendMenuData.graphql
var lendMenuData_graphql = __webpack_require__(5702);
...
var lendMenuPrivateData_graphql = __webpack_require__(5703);
...
var KvAccordionItem = __webpack_require__(563);
...
var LendListMenuvue_type_style_index_0_id_9e16d52e_lang_postcss_scoped_true_ = __webpack_require__(5704);
...
var LendMegaMenuvue_type_style_index_0_id_4c6ff2a2_lang_postcss_scoped_true_ = __webpack_require__(5706);
...
var pageQuery = Object(lib["gql"])(_templateObject || (_templateObject = taggedTemplateLiteral_default()(["query lendMenu {\n\t\tmy {\n\t\t\tid\n\t\t\tuserAccount {\n\t\t\t\tid\n\t\t\t}\n\t\t}\n\t}"])));
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _this.apollo.watchQuery({
                query: Object(lib["gql"])(_templateObject2 || (_templateObject2 = taggedTemplateLiteral_default()(["query countryFacets {\n\t\t\t\t\tlend {\n\t\t\t\t\t\tcountryFacets {\n\t\t\t\t\t\t\tcount\n\t\t\t\t\t\t\tcountry {\n\t\t\t\t\t\t\t\tname\n\t\t\t\t\t\t\t\tregion\n\t\t\t\t\t\t\t\tisoCode\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t}\n\t\t\t\t\t}\n\n\t\t\t\t}"])))
              }).subscribe({
