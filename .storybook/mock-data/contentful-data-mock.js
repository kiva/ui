...
export const appealBanner = {
	...
	"richText": {
		...
		"content": [{
			...
			"content": [{
				"data": {},
				"marks": [],
				"value": "Take the 15,000 loan challenge with us.",
				"nodeType": "text"
			}],
			"nodeType": "paragraph"
		}],
	...
	"startDate": "2020-09-23T00:00-07:00",
	"endDate": "2020-10-23T00:00-07:00",
	"active": true,
	"hiddenUrls": ["/"],
	"bannerType": "Custom Appeal",
	"dataObject": {
		"ctaButtonText": "Find a borrower",
		"shrinkButtonText": "Maybe later",
		"kiva15FundedLoansGoal": 15000
	},
	"additionalContent": [{
		"sys": {
			"space": {
			...
			"id": "127JRxiMO69eaZksGnxwSM",
			"type": "Entry",
			"createdAt": "2020-09-13T23:21:17.897Z",
			"updatedAt": "2020-09-25T14:27:48.733Z",
			"environment": {
				"sys": {
					"id": "development",
					"type": "Link",
		...
		"fields": {
			"key": "kiva15AppealCopy",
			"name": "Kiva15 Custom Appeal Copy",
			"richText": {
				"nodeType": "document",
				"data": {},
				"content": [{
					...
					"content": [{
						"nodeType": "text",
						"value": "Join us in celebrating 15 years of impact by supporting 15,000 people around the world. ",
						"marks": [],
						"data": {}
					}],
					"data": {}
		...
		"bodyCopy": {
			...
			"content": [{
				...
				"content": [{
					"data": {},
					"marks": [],
					"value": "Kiva makes it simple to support causes you care about - every month, automatically.",
					"nodeType": "text"
				}],
				"nodeType": "paragraph"
			}],
...
export const contentfulResponsiveImageSet = {
	"name": "wrd-hero-responsive-image-set",
	"description": "Image Set description",
	"contentType": "responsiveImageSet",
	"images": [{
		"title": "wrd2021-hero lg retina",
		...
		"file": {
			...
			"fileName": "wrd2021-hero-lg-2x.jpg",
			"contentType": "image/jpeg"
		}
	}, {
		"title": "wrd2021-hero med retina",
		"description": "image description text",
		"file": {
			...
			"fileName": "wrd2021-hero-med-2x.jpg",
			"contentType": "image/jpeg"
		}
	}, {
		"title": "wrd2021-hero sm retina",
		"description": "image description text",
		"file": {
			...
			"fileName": "wrd2021-hero-sm-2x.jpg",
			"contentType": "image/jpeg"
		}
	}]
}
