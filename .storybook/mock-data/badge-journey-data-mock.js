export const badgeWomensEquality = {
	"id": "womens-equality",
...
export const badgeUsEconomicEquality = {
...
export const badgeClimateAction = {
	"id": "climate-action",
...
export const badgeRefugeeEquality = {
	"id": "refugee-equality",
