 ...
 * @returns {string}
 */
function helpedLanguage(status) {
 ...
 * @returns {string}
 */
function borrowerCountLanguage(borrowerCount) {
	if (borrowerCount > 1) {
		return 'a member ';
	}
	return '';
 ...
 * @returns {string}
 */
function shortenedLoanUse(loanUse, loanName, loanUseMaxLength) {
 ...
 * @returns {string}
 */
module.exports = function loanUseFilter(loanUse,
	loanName = '',
	loanStatus = '',
	loanAmount = 0,
	loanBorrowerCount = 0,
