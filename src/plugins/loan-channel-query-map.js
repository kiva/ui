		...
		return {
			loanChannelQueryMap: [
				...
				},
				{
					...
					fallbackUrl: '/lend?status=fundRaising&riskRating=0,5&activity=73&kexpn=lend_filter_v2.lend_filter_v2_versions&kexpv=c'
				},
				{
					id: 29,
					url: 'arts',
