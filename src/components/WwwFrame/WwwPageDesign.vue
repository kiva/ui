<template>
	<div class="kv-tailwind">
		<kv-theme-provider :theme="darkTheme">
				...
				<div class="tw-bg-secondary md:tw-bg-primary tw-w-full -tw-mx-2.5 md:tw-mx-0 tw-sticky tw-z-sticky tw-top-0">
					<kv-page-container>
						<div class="tw-flex">
							...
							<ul class="tw-flex tw-gap-2 tw-items-center md:tw-justify-end tw-bg-secondary md:tw-bg-primary">
								<li>
				...
				<div class="tw-bg-secondary tw-py-8">
					<kv-page-container>
						...
						<div class="tw-flex tw-gap-4 tw-mb-1.5 md:tw-mb-0">
							<a class="tw-text-tertiary hover:tw-text-action-highlight" href="https://www.instagram.com/kiva.org" target="_blank">
								<instagram-logo class="tw-w-3" />
								<span class="tw-sr-only">Kiva's Instagram</span>
							</a>
							<a class="tw-text-tertiary hover:tw-text-action-highlight" href="https://www.facebook.com/kiva" target="_blank">
								<facebook-logo class="tw-w-3" />
								<span class="tw-sr-only">Kiva's Facebook</span>
							</a>
							<a class="tw-text-tertiary hover:tw-text-action-highlight" href="https://www.twitter.com/Kiva/" target="_blank">
