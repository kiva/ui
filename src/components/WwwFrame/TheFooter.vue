<template>
	<footer class="tw-py-2 md:tw-py-3
				lg:tw-py-3 tw-bg-tertiary tw-text-primary
	...
	>
		<kv-page-container>
			...
			<nav class="tw-hidden lg:tw-block tw-mt-4" aria-label="Footer navigation">
