...
export default {
	...
	computed: {
		...
		buttonAmounts(props) {
			...
			const donationAmounts = props?.appealBannerContent?.dataObject?.donationAmounts || [];
			return donationAmounts && donationAmounts.length ? donationAmounts : defaultAmounts;
		},
		// NOT YET HOOKED UP
