...
<template>
	<svg viewBox="0 0 199 164" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
		<g class="spark spark-1" clip-path="url(#clip3_8313_593)">
			<rect x="12" y="30" width="24.5106" height="27" fill="url(#pattern3_8313_593)" />
		</g>
		...
		<g class="spark spark-3" clip-path="url(#clip2_8313_593)">
			<rect x="1.33691" y="137.118" width="24.5106" height="27" fill="url(#pattern2_8313_593)" />
		</g>
		<g class="spark spark-4" clip-path="url(#clip1_8313_593)">
			<rect x="156.901" y="18.4602" width="16.5287" height="17.617" fill="url(#pattern1_8313_593)" />
		</g>
		<defs>
			...
			<pattern id="pattern3_8313_593" patternContentUnits="objectBoundingBox" width="1" height="1">
				<use xlink:href="#image0_8313_593" transform="scale(0.0078125 0.0070922)" />
			</pattern>
			...
			<clipPath id="clip1_8313_593">
				<rect width="18.383" height="17.617" fill="white" transform="translate(156 18.3829)" />
			</clipPath>
			<clipPath id="clip2_8313_593">
				<rect width="27.2604" height="27" fill="white" transform="translate(0 137)" />
			</clipPath>
			<clipPath id="clip3_8313_593">
				<rect width="27.2604" height="27" fill="white" transform="translate(12 30)" />
			</clipPath>
...
.spark {
	animation: glitter 3s ease-in infinite, jump 15s step-start infinite;
	opacity: 0;
}
