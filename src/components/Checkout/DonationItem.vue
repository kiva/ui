<template>
	<div class="basket-donation-item row">
		...
		>
			<p>
				100% of money lent on Kiva goes to funding loans, so we rely on donations
				to continue this important work. Each dollar helps us invest in systemic
				change and spread financial inclusion around the world.
			</p>
			<p>
				We’re investing in lasting solutions for a more inclusive world through
				your donations. Projects like...
			</p>
			<ul style="margin-bottom: 1rem;">
				<li>
					Kiva Protocol, giving unbanked people a digital identity and secure
					control over their own credit information in places like Sierra Leone.
				</li>
