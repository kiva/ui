	...
	<div class="small-12 large-10 columns tw-prose">
		...
		<div class="row summary-row">
			...
			<div class="small-12 xlarge-4 columns">
				...
				<p>
					...
					Welcome to Kiva! You’re legally agreeing to the terms on this page when you visit and use Kiva’s website. So you should read them. This column can help you navigate the major points in the terms.<br>
					<br>
		...
		<div class="row summary-row">
			...
			<div class="small-12 xlarge-4 columns">
				...
				<p>
					<strong>Basically,</strong><br>
					The Terms of Use is the current agreement between you and Kiva. If you have any other contracts with Kiva (for example if you are a Kiva borrower or a loan matching sponsor), those may override certain things in this Terms of Use.<br>
					<br>
		...
		<section>
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					<p>
						Kiva manages the Website, which matches you and other Users with borrowers and social enterprises in various countries in need of affordable capital (each, a "Borrower" and, collectively, "Borrowers"). In most instances, these Borrowers are considered "high risk" by traditional lenders for a variety of factors, including, but not limited to, the Borrowers' lack of credit history, the use of the loan proceeds for entrepreneurial endeavors including investment in a "start up" business, and the geographic location including the risk of financial instability and foreign exchange rate fluctuations. Please carefully review the Website section entitled "<a href="/about/due-diligence" target="_blank">Due Diligence</a>" which highlights the various risks associated with lending online through Kiva and explains in greater detail the role played by Kiva and its Lending Partners and Trustees (each defined below in this Section 1).
					</p>
				</div>
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						<span>This section describes what Kiva does. Lending on Kiva is risky and you might not get repaid what you lend. Please read our page called “<a href="/about/due-diligence#due-diligence-risk-types-faq" target="_blank">Due Diligence</a>” for more information on the different types of risk you assume when you make a loan.</span>
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					<p>
						You may participate in the Program by creating an online account on the Website registered to your email address, or by using a guest checkout feature, as described below in Section 1.3. If you participate via Kiva's mobile app, you may not have access to all Website features and functionality through the app; however, you can access all your account settings, functionality, and information about your lending history through Kiva's website at kiva.org. You may use the Website to fund loans from your Kiva account, <span class="tw-bg-caution tw-text-black">to donate funds to Kiva for the purpose of lending</span>, and/or to donate to Kiva's operations. All transactions between Lenders and Borrowers or Lending Partners must be conducted through a Kiva account, except when using guest checkout. All amounts deposited in your Kiva account must be lent through the Website and/or donated to Kiva. The funds you have available in your Kiva account which are freely available to be lent or donated – whether deposited from your personal funds, value from a Kiva Card (as defined below in Section 1.10), or repayments on previously made Loans – are referred to as your "Kiva Credit."
					</p>
					<p>
						<span class="tw-bg-caution tw-text-black">The following paragraphs describe the two main ways to support loans to Borrowers on the Website.  A User who wishes to donate money (eligible for tax deduction in the United States) that Kiva will use to fund loans may do so via a "Donate-to-Lend Page" as described in Section 1.1.  Money donated through a Donate-to-Lend Page is permanently donated to Kiva and will not be repaid to the User's Kiva account.  Alternatively, a User who wishes to select individual loans to fund, with the possibility of receiving loan repayments to the User's account, may do so via Kiva's lending program described in Section 1.2.</span>
					</p>
				</div>
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						<span>You have to create an account to lend or donate on Kiva, unless you check out as a guest. Money added to your account is called "Kiva Credit" and it must be used to make loans on Kiva or donate to Kiva. <span class="tw-bg-caution tw-text-black">You can direct funds toward Kiva loans in different ways, including donations to Kiva that will be used for lending, as well as loans that are eligible to be repaid to your account.</span></span>
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					...
					<p>
						<span class="tw-bg-caution tw-text-black">If you have a Kiva account, you understand and agree that funds donated through a Donate-to-Lend Page WILL NOT be credited toward or otherwise reflected in your Kiva account.  Repayments on the loans supported by these donations will not be shown in your account or repaid to you in any way.  Furthermore, donations made through a Donate-to-Lend Page are not eligible for any promotions that may be advertised by Kiva from time to time in connection with lending or donating directly to Kiva's operations.</span>
					</p>
				</div>
				...
				<div class="small-12 xlarge-4 columns">
					<svg class="icon arrow"><use xlink:href="#icon-small-chevron" xmlns:xlink="http://www.w3.org/1999/xlink" /></svg>
					<p>
						<span class="tw-bg-caution tw-text-black"><strong>Basically,</strong></span><br>
						<span class="tw-bg-caution tw-text-black">If you donate money to Kiva through a Donate-to-Lend Page, Kiva will use your donation to fund loans.  You will not be able to choose which specific loans to fund, and you will not receive any repayments.  The money will be re-lent to other borrowers as it is repaid, although Kiva will use a portion of each repayment to fund its operations.</span>
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					...
					<p>
						If Kiva receives repayments on your Loans from the applicable Borrowers/Lending Partners, such repayment amounts will be shown in your account as Kiva Credit, but technically will not be returned to your Kiva account unless and until you instruct Kiva to apply such amounts toward another Loan or donate such amounts to Kiva. Alternatively, you can request that Kiva pay you an amount equivalent to such repayments by requesting a withdrawal. You must have both a Kiva account and a PayPal account to receive and withdraw repayments. Please note that PayPal does not facilitate payments in all countries - if PayPal does not allow payments to be received in your country, you will not be able to withdraw your funds.
					</p>
				</div>
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						<span>When you make a loan with your own money, either by choosing borrowers or by using Kiva’s auto-lending feature, Kiva will lend the funds on your behalf.  As borrowers repay, you can relend the money or Kiva can pay you back. You need to have both a Kiva account and a PayPal account to withdraw payments from Kiva.</span>
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						Kiva raises money for our operations separate from the loans you make from your account. This means we won't use the money in your Kiva account to run our organization (unless you decide to donate it to us).
					</p>
				</div>
			</div>
			...
			<p>
				<strong>b. Types of Loans on the Website.</strong>
			</p>

			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					<p>
						<u>Partner Loans.</u> The majority of Loans on the Website are administered by existing domestic and international organizations (each, a "Lending Partner" and, collectively, "Lending Partners") that work in underbanked or low-income communities and generally have a stated mission to reduce poverty by providing affordable working capital, services or supplies to underbanked or low-income borrowers (“Partner Loans”). When a Partner Loan is funded, Kiva sends Lender funds to the Lending Partner administering the Partner Loan, and receives Borrower repayments via the Lending Partner as the Loan is repaid.
					</p>
				</div>
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						Most loans on Kiva's website are posted by third-party organizations we call “Lending Partners.” Lending Partners disburse money to borrowers and collect repayments, which they then send to Kiva.
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						A few loans on Kiva's website are posted and managed by Kiva without any assistance from a Lending Partner – we call these “direct loans.” In general, direct loans have a higher risk of non-repayment than Lending Partner loans because there's no third-party institution managing the loan. Some direct loans are endorsed by “Trustees,” which are people or institutions that vouch for the borrower's character but do not actually handle the loan.
					</p>
				</div>
			</div>

			<p>
				<strong>c. Loan Disbursement.</strong>
			</p>

			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					<p>
						<u>Partner Loan Disbursement.</u> Partner Loans are not made directly to Borrowers, but are instead administered by Lending Partners. Loan requests are posted in cooperation with such Lending Partners and are, before being listed on Kiva, converted to U.S. dollar amounts as necessary and then rounded up to the nearest U.S. dollar increment of 25, to help streamline the Loan transaction process. Funds loaned by you, the Lender, will be delivered to Lending Partners for ultimate disbursement to, or backfilling of Loans to, the Borrower(s). In certain cases, Borrowers may receive goods and services funded by Loan amounts, such as agricultural packages, from Lending Partners, instead of the monetary amount of the Loan. A Lending Partner may voluntarily choose to pre-fund your Borrower in the short-term from its own funds in anticipation of receiving your Loan amounts as backfill. This helps reduce the time the Borrower needs to wait until the Loan is funded on the Website and the funds are delivered to the Lending Partner. Kiva serves as a middle-man in the process and aggregates funds from multiple Lenders via the Website and delivers 100% of these funds on a net billing basis (excluding the interest earned, if any, on such funds while they are held in a User Funds Account, which interest is contributed toward funding Kiva's operations) to the Lending Partner(s) for disbursement to the Borrowers funded through the Website. Please note that many Lending Partners require mandatory savings as part of their transaction process to serve as collateral, which savings may help ensure that Borrowers are able to accumulate cash and represent a good risk. In certain cases, mandatory savings (and fees) are netted by Lending Partners against the Loans forwarded by Kiva.
					</p>

					<p>
						The process of disbursement to a Borrower in a particular country, however, may vary from the standard disbursement structure just described. Currency and other national or local regulations may require a different philanthropic funding structure in some countries. In such cases, instead of Loan funds being forwarded directly to the corresponding Lending Partner, Kiva may, for example, have to transact with other intermediaries (such as the Lending Partner's U.S.-based affiliates or other third parties licensed in the particular country to transact in foreign currencies) to structure a different indirect funding process that enables a Borrower to ultimately be supported by a Partner Loan from you. In some cases, Kiva may approve a Lending Partner's pledge of collateral to another lender that may include loans supported by Kiva Users.
					</p>
				</div>
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						This section explains how we get your money to borrowers. Most loans are distributed to borrowers through Kiva's Lending Partners. Kiva works with lots of different types of Lending Partners and borrowers in different countries, so the process of loan distribution can vary depending on the loan.
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					<p>
						Lending Partners are solely responsible for screening and selecting each Borrower (including, without limitation, posting requests for Partner Loans on the Website) and making all Partner Loan disbursements, and Kiva expressly disclaims any responsibility to screen or select any Borrower or any Lending Partner or monitor the disbursement of Loan proceeds from the Lending Partner(s) to the Borrower(s). Kiva and its Lending Partners shall have no liability whatsoever with respect to such screening or selection of Borrowers or Lending Partners and the disbursement of Loan proceeds from the Lending Partner(s) to the Borrower(s), and you shall hold Kiva and its Lending Partners harmless from any and all liabilities with respect to, or resulting from such screenings, selections and disbursements.
					</p>
				</div>
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						For partner loans, Kiva doesn’t choose the individual borrowers posted to our website by Lending Partners. Neither Kiva nor our Lending Partners will be liable to you should problems arise with Lending Partners, borrowers or the loan disbursement process.
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						Kiva does select borrowers who receive a direct loan and sends them the money without help from a Lending Partner. Neither Kiva, nor anyone who endorses a direct loan, will be liable to you if any problems arise with these borrowers.
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					<p>
						<strong>d.<span class="long-tab"></span>Loan Collection and Repayment.</strong> Partner Loans are repaid by Borrowers to the Lending Partners. Generally, as a Borrower repays a Loan, the respective Lending Partner will post a record to the Website of such repayments actually received by the Lending Partner, and it is the responsibility and obligation of the applicable Lending Partner to pay over such collected Loan repayments to Kiva. In some cases (for example, for Loans in India), the records of repayments are not posted on the Website as the Borrowers repay the Loans, as a result of certain system and country regulatory constraints. Direct Loans are repaid directly by Borrowers to Kiva, without facilitation by a Lending Partner. Repayments may be made in periodic installments, depending on the terms of the applicable Loan. In some cases (for example, for Loans in India), repayments may only be provided at the end of a fixed term (for example, after 43 months), as a result of certain system and country regulatory constraints. Except as may be provided in Section 1.3 (Guest Checkout), Section 1.2(e) ("Principal Loss Scenarios") or Kiva’s <router-link to="/legal/promo-terms-of-use-february-2020">
							Promotional Lending Terms and Conditions</router-link>, Kiva commits to pay to Lenders on a pro rata basis (in accordance with the amounts loaned by each such Lender to a given Borrower) amounts equivalent to the repayments actually received by Kiva from such Borrower (whether directly from the Borrower or from a Lending Partner). Repaid amounts will show as Kiva Credit in your account, but technically speaking these funds (which reflect amounts Kiva owes to you) are held by Kiva until you instruct us to (a) use the amounts repaid to make new Loans through your Kiva account, (b) pay you an equivalent amount by requesting a withdrawal, or (c) donate the amounts to Kiva. Distributions to Lenders may, in Kiva's sole discretion, be made periodically or in one lump sum once 100% of all Loan proceeds for a particular Loan have been received by Kiva. Furthermore, please note that timing of distributions to Lenders may vary and may be materially impacted because of circumstances that, in Kiva's judgment, require Kiva to conduct further reviews with respect to the collected repayments (for example, to resolve issues regarding accuracy of repayment amounts and corresponding data, or for other issues). If, for any reason, a given Lending Partner is unable to collect Partner Loan repayments directly from the Borrower(s) or if Kiva, for any reason, is unable to collect Loan repayments directly from a Lending Partner or a Borrower, repayment of your Loan amounts could be at risk of partial or total delay or non-repayment and a loss of some or all of your principal could occur. You hereby acknowledge and agree that neither Lending Partners nor Borrowers will have direct contractual obligation or liability to pay you any principal and that Kiva is only obligated to repay such Loan principal to the extent actually received by Kiva from a Lending Partner or a Borrower (subject to the conditions noted above). None of Kiva, its Lending Partners or any Borrower will have any obligation to pay interest on the Loan or other fees or amounts (other than as expressly set forth above) to you or any other Lender in connection with any Loan you make. However, you should note that in some cases Kiva charges service fees to Lending Partners and Direct Loan Borrowers, and Lending Partners generally also charge interest and fees to Borrowers.
					</p>
				</div>
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						This section explains how loan repayment works. After we receive a repayment on one of your loans, we will pay you and the other lenders back in proportion to how much everyone lent. You can also choose to use repaid amounts to make new loans. If a borrower or Lending Partner doesn’t send repayments to Kiva as expected, you won’t get your money back. You don’t have the right to seek repayments directly from Lending Partners or borrowers.
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						In addition to loan defaults, you may lose money because of changing currency exchange rates. Kiva loans are made in U.S. dollars, but Lending Partners often distribute the money to borrowers in their local currency. Sometimes local currency becomes less valuable during the term of a loan. This means that by the time a borrower repays his or her loan, it might equal less than the original loan amount when it’s converted back to U.S. dollars.
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					<p>
						If for any reason less than 100% of your Loan is repaid, regardless of whether you made such Loan manually or pursuant to Auto-Lending, you agree that neither Kiva nor its Borrowers, Lending Partners or Trustees (as well as any "related Lending Partner or Trustee entity" – for example, one that as part of a restructuring or otherwise, assumes control over such a Lending Partner or Trustee, its assets and/or its obligations) shall have any liability therefor, and you hereby release and forever hold harmless Kiva, its Borrowers, Lending Partners, Trustees and any related Lending Partner or Trustee entity for any loss you may incur. You should consult with your accountant and/or tax advisors to determine the appropriate tax treatment of such a loss.
					</p>
				</div>
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						If any part of your loan is not repaid, you will lose that money. You won’t sue Kiva, Borrowers, Lending Partners, Trustees, or anyone else for your losses.
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					<p>
						From time to time, Kiva may offer a guest checkout feature that allows you to make one or more Loans <span class="tw-bg-caution tw-text-black">or donations</span> through the Website without creating a Kiva account. If you make a Loan <span class="tw-bg-caution tw-text-black">or donation</span> through a guest checkout feature, you will need to provide your email address, and you will still be subject to Kiva's Terms of Use and Privacy Policy. You agree that Kiva may contact you via email at the email address you provide when checking out as a guest. You understand and agree that you will not be able to receive or withdraw amounts corresponding to Loan repayments if you do not have a Kiva account. From time to time, Kiva may allow you to “claim” your guest Loan(s) <span class="tw-bg-caution tw-text-black">or view your guest donations</span> by enabling you to finish creating a Kiva account associated with the email address you provided when checking out as a guest. Kiva reserves the right to set time limits on when you must finish creating your Kiva account in order to claim a guest Loan <span class="tw-bg-caution tw-text-black">or donation</span>. You agree that Kiva shall have sole discretion to use as Kiva sees fit any and all funds that are repaid on any Loan you make as a guest and do not later claim within the time period set by Kiva.
					</p>
				</div>
				...
				<div class="small-12 xlarge-4 columns">
					<svg class="icon arrow"><use xlink:href="#icon-small-chevron" xmlns:xlink="http://www.w3.org/1999/xlink" /></svg>
					<p>
						<span><strong>Basically,</strong></span><br>
						<span>Kiva may allow you to lend <span class="tw-bg-caution tw-text-black">or donate</span> without a Kiva account. If you choose to lend as a guest, you will need to provide an email address, and Kiva may let you finish creating an account linked to your email address later. If you do not later create an account, you won't be able to receive loan repayments, and Kiva will decide what to do with any repayments on your guest loan.</span>
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					<p>
						In the event that you make a Loan <span class="tw-bg-caution tw-text-black">or a donation</span> and your payment does not clear (e.g., an eCheck does not validly deliver to Kiva the full Loan <span class="tw-bg-caution tw-text-black">or donation</span> amount, or your payment provider reverses a payment originally intended for Kiva), you agree that Kiva may, in its sole discretion, (i) offset the insufficiently funded amount against your Kiva Credit if your account contains it, or (ii) if you do not deposit Kiva Credit sufficient to cover the shortfall, close your account.
					</p>
				</div>
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						If you try to make a loan <span class="tw-bg-caution tw-text-black">or donation</span> and your payment doesn't clear, we can cover it with Kiva credit from your account (if you have any), or close your account if you do not deposit the necessary credit.
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						Kiva is a 501(c)(3) nonprofit that runs on donations. If you donate money to Kiva, the donations qualify for a tax deduction in the U.S. However, if you make a loan from your Kiva account or through guest checkout, it isn't considered a donation to Kiva and isn't tax deductible.
					</p>
					<p>
			...
			<div class="row summary-row">
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						You can check your lending history and account balance by signing into your Kiva account, or by writing to Kiva to ask for it
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					...
					<p>
						You will upon registration on the Website automatically be opted-in to instructing Kiva to auto-convert any remaining amounts owed to you (in connection with Loan repayments or otherwise) to a donation to Kiva's general operating expenses to further Kiva's philanthropic mission if your account becomes inactive for a period of 24 or more consecutive months. Please note that you are free to change this pre-set option in your discretion and at any time in advance (although you understand any funds that have been auto-donated based on the then-existing preference setting shall not be revocable once the auto-donation has taken place).
					</p>
				</div>
			...
			<div class="row summary-row">
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						If your account becomes inactive without valid instructions for what to do with any money we owe you, we may send it to your home state government so that you can claim it later. This could happen if, for example, you’ve told us to return the funds to your PayPal account, but we can’t for some reason (for instance, if you haven’t given us a correct PayPal account). If you live outside the U.S., or if we don’t know where you live, we will send the money to the State of California.
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					<p>
						Kiva may offer certain promotions and promotional products to Users, including but not limited to features that allow a User to make a Loan on the Website without spending their own personal funds or Kiva Credit. This Agreement, Kiva’s <router-link to="/legal/promo-terms">
							Promotional Lending Terms and Conditions</router-link>, and any other specific terms posted by Kiva with respect to such promotions and promotional products, shall apply to all Users’ participation in the promotions and use of promotional products.
					</p>
				</div>
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						If we offer any special promotions to you (like the ability to make a loan without using your own money), additional terms may apply. You can read our <router-link to="/legal/promo-terms">
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					<p>
						A “Kiva Card” is a hybrid gift product with inherent built-in features that combine elements of both the ability to make a Loan on the Website and an automatic charitable donation to Kiva. The terms and conditions applicable to Kiva Cards can be found here: <a href="http://www.kiva.org/gifts/kiva-cards/terms"> Kiva Card Terms and Conditions</a>.
					</p>
				</div>
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						If you want to gift Kiva to someone, you can purchase a “Kiva Card,” which allows them to make a loan on Kiva, or donates the value of the card to Kiva if they choose not to make a loan within 1 year. There are specific terms and conditions that apply to Kiva Cards. You can <a href="https://www.kiva.org/gifts/kiva-cards/terms">read those here</a>.
					</p>
				</div>
			</div>
		</section>
		...
		<section>
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					...
					<p>
						You may not use the Website in any manner that could damage, disable, overburden or impair the Website or software, systems or equipment of Kiva or any User, Lending Partner, or other person. You may not use the Website in any manner that, in Kiva’s sole discretion, creates a poor user experience for any other User, such as by posting content specifically designed to attract a negative reaction from an individual or group, or by “keyword stuffing” lending team pages (loading a page description with keywords in an attempt to manipulate the page’s ranking in search results). Although Kiva assumes no obligation to monitor the conduct of any User on or off the Website or through the Program, it is a violation of this Agreement to use the Website or Program, or any information obtained from the Website or Program, in order to: (i) harass, abuse, or harm another person (including, but not limited to, using profanity in messages or creating or joining lending teams in bad faith), (ii) prevent or exclude others, who are using the Website in compliance with this Agreement, from accessing, viewing or funding a particular Borrower profile, (iii) promote or enable illegal activities, (iv) defraud or deceive any person, (v) promote or solicit involvement in support of any political platform, legislation or campaign activity for or against political candidates, (vi) publicly share information about a Borrower’s delinquency or default, (vii) access and use the Website by scripts, bots or other automated technology, (viii) contact, advertise to, solicit, "spam," or sell to any User, Lending Partner, Trustee, Borrower or other person without their prior explicit consent (provided that Borrowers may promote their businesses to Users in a respectful way), or (ix) post, upload, submit, transmit or otherwise share any content, including, but not limited to, written materials or images, that in Kiva's opinion is obscene, harassing, contains profanity, or may be hateful or offensive on racial, ethnic, sexual or any other grounds; is harmful, vulgar or distasteful; contains graphic or gratuitous violence; is defamatory, libelous, or invades another person's privacy or proprietary rights; or contains viruses, time bombs, trojan horses, cancelbots, worms or other harmful or disruptive codes, components or devices.
					</p>
		...
		<section>
			...
			<div class="row summary-row">
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						Kiva owns our name, logo, branding and all the content on our website, and you can’t use it without our permission. That said, you can share website content if it relates to your use of Kiva (and if you’re not making any money off it).<br>
						<br>
			...
			<div class="row summary-row">
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						We can view, save and share anything you post on the website, as well as your account information, for the reasons listed in this section. Our <a href="https://www.kiva.org/legal/privacy">Privacy Policy</a> says more about how we collect and use your information and content.
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					...
					<p>
						...
						Kiva Microfunds<br>
						Legal Department<br>
						182 Howard Street, Suite 414<br>
						San Francisco, CA 94105 USA<br>
					</p>
					<p>
						<strong>By Fax:</strong><br>
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						If you see something posted to the Kiva website without its owner’s permission, please let us know by following the instructions in this section. If we remove something you’ve posted and you think you had the right to post it, you can let us know about that too.
					</p>
				</div>
			</div>
		...
		<section>
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					<p>
						Kiva is not responsible, and shall have no liability, for any incorrect or inaccurate content posted on the Website or any liability, cost or expense you may incur in connection with the Website or Program, whether caused by any User, Lending Partner, Trustee, Borrower or other person or by any of the equipment or programming associated with or utilized in the Program. You also acknowledge and agree that neither Lending Partners, Trustees, nor Borrowers are liable for content created and posted on the Website, and neither Lending Partners nor Trustees guarantee repayment by any Borrower. Kiva is not responsible for the conduct, whether online or offline, of any User of the Website or any other person. With respect to the Website and Program, Kiva assumes no responsibility for any error, omission, interruption, deletion, defect, delay in operation or transmission, communications line failure, theft or destruction or unauthorized access to, or alteration of, any communications.
					</p>

					<p>
						Kiva is not responsible for your interactions with any Lending Partners, Trustees, any other User or any Borrower (even to the extent prohibited by this Agreement) and any disputes or damages that may result from such interactions. Kiva reserves the right, but has no obligation, to monitor disputes between you and such persons.
					</p>
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						Kiva isn’t liable for any problems you may have if you use the website for lending, borrowing or otherwise, even if those problems are caused by our mistake or another person’s bad behavior. Lending Partners, Trustees and borrowers aren’t liable to you either.
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						While we strive for correct information on the Kiva website, we don’t double check the accuracy of everything posted on our website, including loans posted by Lending Partners. When you use the Kiva website or make a loan, you assume the risks and are responsible for your own decisions.
					</p>
				</div>
			</div>
		</section>
		...
		<section id="final-section-padding-termsofuse">
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					<p>
						This Agreement, accepted upon your access and use of the Website or participation in the Program and further affirmed by becoming a User, contains the entire agreement between you and Kiva regarding the use of the Website or the Program. Notwithstanding the foregoing, the following applies to Borrowers, Trustees, and Lending Partners: in the event of any irreconcilable conflict between your separate written Borrower, Trustee, or Lending Partner agreement with Kiva (as applicable) and this Terms of Use Agreement, the provisions of your Borrower, Trustee, or Lending Partner agreement (as applicable) shall govern with respect to such conflict. This Agreement may not be orally amended. If any provision of this Agreement is held invalid, the remainder of this Agreement shall continue in full force and effect.
					</p>
					...
					<p>
						Please contact us at <a href="mailto:contactus@kiva.org">contactus@kiva.org</a> with any questions regarding this Agreement, or to request a written copy of this Agreement.
					</p>
				</div>
