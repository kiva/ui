	...
	<div class="small-12 large-10 columns tw-prose">
		...
		<section>
			...
			<div class="row summary-row">
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						This section describes what Kiva does. Lending on Kiva is risky and you might not get repaid what you lend. Please read our page called “<a href="https://www.kiva.org/about/due-diligence/risk">The risks of lending</a>” for more information on the different types of risk you assume when you make a loan.
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						Most loans on Kiva’s website are posted by third-party organizations we call “Field Partners.” Field Partners disburse money to borrowers and collect repayments, which they then send to Kiva.
					</p>
				</div>
			</div>
			...
			<div class="row summary-row">
				...
				<div class="small-12 xlarge-4 columns">
					...
					<p>
						<strong>Basically,</strong><br>
						This section explains how we get your money to borrowers. Most loans are distributed to borrowers through Kiva’s Field Partners. Kiva works with lots of different types of Field Partners and borrowers in different countries, so the process of loan distribution can vary depending on the loan.
					</p>
				</div>
			</div>
		...
		<section>
			...
			<div class="row summary-row">
				<div class="small-12 xlarge-8 columns">
					<p>
						This Agreement will remain in full force and effect while you access or use the Website or participate in the Program as a User and, notwithstanding anything herein to the contrary, this Agreement will remain in effect after your participation in the Program and registered account is terminated. From time to time, Kiva may make features available to Users as part of the Program. Kiva reserves the right, in its sole discretion, to include or cease providing these features at any time. Whether or not you are and remain eligible to participate in the Program, use the Website, or take advantage of any Kiva services, may be determined by Kiva in its sole and absolute discretion. You may terminate your participation in the Program and registered account at any time and for any reason through your Account Settings.  Any funds remaining in your account at the time of deletion, as well as any funds later repaid to the account, will be automatically donated to Kiva.
					</p>
				</div>
