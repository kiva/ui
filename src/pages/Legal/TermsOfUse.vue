					...
					<div class="row summary-row">
						<div class="small-12 xlarge-8 columns">
							...
							<p>
								...
								Kiva Microfunds<br>
								Legal Department<br>
								875 Howard Street, Suite #340<br>
...
div.summary-row > :first-child p:last-child {
	margin-bottom: 0;
}
