...
<!--PSD TODO remove modal for simple dropdown menu for tailored queries -->

<!--PSD HOWTO pass queries to dev graphql endpoint -->
<!-- write a query via appollo here in the page? -->
<!-- pass a query through a different components, which will render them on the page? -->

<!--PSD HOWTO pass loan ids from query to federation  -->

<!--HOWTO create slug for placeholder page for PSD web previews -->
    <!--TODO add route to  -->

<!--WHERETO a psd placeholder page for PSD web experiments/loan displays -->
<!--  nowhere  any and all PSD changes should stay on a feature branch -->
<!--  a PSD directory and the slug would for any changes to a:  make a folder in /pages/prototyping-->
