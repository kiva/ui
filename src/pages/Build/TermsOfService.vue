	...
	<www-page>
		...
		<build-page-wrapper class="tw-prose">
			...
			<p>
				...
				(a) the Kiva Terms of Use (located at http://www.kiva.org/legal/terms) and
				(b) the Kiva Privacy Policy (located at http://www.kiva.org/legal/privacy).
				In the event of any irreconcilable conflict between this Agreement and
				any of the Kiva Terms of Use or Kiva Privacy Policy, the provisions of
				this Agreement shall govern. This Agreement may be modified by Kiva in
				its sole discretion from time to time and such modifications shall
				automatically become part of this Agreement and shall be effective
				once posted by Kiva on the Kiva Website (as indicated by the posted
				update date). Your License will be subject to any such modifications.
				You should review the Website and this Agreement from time to time for
				any modifications. If you do not agree with any such modifications,
				please immediately terminate your use of the Licensed API (as defined below),
				as outlined in Section 11 below.
			</p>
			<h2 class="tw-text-headline">1. Definitions</h2>
			<p>
			...
			<h2 class="tw-text-headline">2. Grant of License</h2>
			<p>
				<!-- eslint-disable-next-line max-len -->
			...
			<h2 class="tw-text-headline">3. Proprietary Rights</h2>
			<p>
				<!-- eslint-disable-next-line max-len -->
			...
			<h2 class="tw-text-headline">4. Other Restrictions</h2>
			<p>
				<!-- eslint-disable-next-line max-len -->
			...
			<p>
				<!-- eslint-disable-next-line max-len -->
				(d)	Licensee shall maintain its own terms of service and privacy policy applicable to users of such Developed Application (collectively, “Licensee Terms”), which Licensee Terms shall specify, at a minimum, what data Licensee and the Developed Application collect and how Licensee and the Developed Application use, display, share, transfer and dispose of such data. Licensee shall comply with such Licensee Terms and prominently identify and link to such Licensee Terms at those locations where the applicable Developed Application is downloadable or accessible and in the Developed Application. Licensee shall promptly notify Kiva of any breaches of Licensee Terms by Licensee.
			</p>
			<p>
				<!-- eslint-disable-next-line max-len -->
			...
			<h2 class="tw-text-headline">6. Additional Licensee Obligations</h2>
			<p>
				<!-- eslint-disable-next-line max-len -->
			...
			<h2 class="tw-text-headline">7. Disclaimers</h2>
			<p>
				<!-- eslint-disable-next-line max-len -->
			...
			<h2 class="tw-text-headline">8. Support and Upgrades</h2>
			<p>
				<!-- eslint-disable-next-line max-len -->
				This Agreement does not entitle Licensee to any support for the Licensed API, unless Licensee makes separate arrangements with Kiva in a writing that is signed by Kiva and Licensee, and Licensee pays all fees associated with such support. Any such support provided by Kiva shall be subject to the terms of this Agreement. Please contact build_kiva@kiva.org with any questions and comments regarding the Kiva API.
			</p>
			<h2 class="tw-text-headline">9. Limitation of Liability</h2>
			<p>
				<!-- eslint-disable-next-line max-len -->
			...
			<h2 class="tw-text-headline">10. Indemnification</h2>
			<p>
				<!-- eslint-disable-next-line max-len -->
			...
			<h2 class="tw-text-headline">11. Term and Termination</h2>
			<p>
				<!-- eslint-disable-next-line max-len -->
			...
			<h2 class="tw-text-headline">12. Government Use</h2>
			<p>
				<!-- eslint-disable-next-line max-len -->
			...
			<h2 class="tw-text-headline">13. Export Controls</h2>
			<p>
				<!-- eslint-disable-next-line max-len -->
			...
			<h2 class="tw-text-headline">14. Governing Law; Resolution of Disputes; Arbitration and Waivers</h2>
			...
			<h2 class="tw-text-headline">15. Miscellaneous</h2>
			<p>
				<!-- eslint-disable-next-line max-len -->
