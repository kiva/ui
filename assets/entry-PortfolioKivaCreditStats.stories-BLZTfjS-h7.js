...
`,Qt={title:"Page/Portfolio/Kiva Credit Stats",component:m},x=()=>({components:{KivaCreditStats:m,KvGrid:d,KvPageContainer:c},mixins:[p({loading:!0}),f()],template:v}),_=()=>({components:{KivaCreditStats:m,KvGrid:d,KvPageContainer:c},mixins:[p({queryResult:y("25.00","25.00")}),f()],template:v}),S=()=>({components:{KivaCreditStats:m,KvGrid:d,KvPageContainer:c},mixins:[p({queryResult:y("0.00","0.00")}),f()],template:v}),b=()=>({components:{KivaCreditStats:m,KvGrid:d,KvPageContainer:c},mixins:[p({queryResult:y("50.00","0.00")}),f()],template:v}),K=()=>({components:{KivaCreditStats:m,KvGrid:d,KvPageContainer:c},mixins:[p({queryResult:y("0.00","75.00")}),f()],template:v}),C=()=>({components:{KivaCreditStats:m,KvGrid:d,KvPageContainer:c},mixins:[p({queryResult:y("856235.57","2346.67")}),f()],template:v}),k=()=>({components:{KivaCreditStats:m,KvGrid:d,KvPageContainer:c},mixins:[p({queryResult:y("8662.00","35752.45")}),f()],template:v});var F,R,T;x.parameters={...x.parameters,docs:{...(F=x.parameters)==null?void 0:F.docs,source:{originalSource:`() => ({
  components: {
    KivaCreditStats,
    KvGrid,
    KvPageContainer
  ...
  template
})`,...(T=(R=x.parameters)==null?void 0:R.docs)==null?void 0:T.source}}};var O,B,E;_.parameters={..._.parameters,docs:{...(O=_.parameters)==null?void 0:O.docs,source:{originalSource:`() => ({
  components: {
    KivaCreditStats,
    KvGrid,
    KvPageContainer
  ...
  template
})`,...(ot=(et=k.parameters)==null?void 0:et.docs)==null?void 0:ot.source}}};const Xt=["Loading","OneLoanOneDeposit","NoLoansNoDeposits","LoansWithNoDeposits","DepositsWithNoLoans","MoreLoansThanDeposits","MoreDepositsThanLoans"];export{K as DepositsWithNoLoans,x as Loading,b as LoansWithNoDeposits,k as MoreDepositsThanLoans,C as MoreLoansThanDeposits,S as NoLoansNoDeposits,_ as OneLoanOneDeposit,Xt as __namedExportsOrder,Qt as default};
