import{p as B}from"./entry-imageUtils-Bap1kCOa3o.js";import{V as A}from"./entry-KvUserAvatar-mdUNSv4mkO.js";import{c,a as N,F as D,r as T,t as j,g as P,n as d,h as U,o as r,f as V,H as E}from"./entry-vue.esm-bundler-ED6DvobC3-.js";import{_ as Z}from"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";import"./entry-mdi-BeeDX8vtDa.js";import"./entry-KvLoadingPlaceholder-BIZZosYllW.js";import"./entry-_plugin-vue_export-helper-9uN0dvLoeT.js";import"./entry-KvMaterialIcon-BM2HtuQNzV.js";const L={name:"SupportedByLenders",components:{KvUserAvatar:A},props:{participants:{type:Object,required:!0,default:()=>({})},isChallenge:{type:Boolean,default:!1},minimal:{type:Boolean,default:!1}},computed:{participantsNumber(){var a,e,t;return this.isChallenge?((a=this.participants)==null?void 0:a.totalCount)??0:((t=(e=this.participants)==null?void 0:e.values)==null?void 0:t.length)??0},participantsText(){return this.isChallenge?this.participantsNumber===1?`${this.participantsNumber} member`:`${this.participantsNumber} members`:this.participantsNumber===1?`${this.participantsNumber} person`:`${this.participantsNumber} people`},supportText(){return this.isChallenge?`${this.participantsText} participating`:`Supported by ${this.participantsText}`},participationLendersDisplayed(){var a;return(((a=this.participants)==null?void 0:a.values)??[]).map(e=>{var n;return{...(e==null?void 0:e.lender)??e,isLegacyPlaceholder:B((n=e.image)==null?void 0:n.url.split("/").pop())}}).filter(e=>e.image).slice(0,5)}}},z={class:"tw-flex tw-shrink-0 tw-items-end","data-testid":"participation-lenders"},F={key:0,class:"tw-px-1 tw-text-base"};function H(a,e,t,n,I,l){const k=U("kv-user-avatar");return r(),c("div",{class:d(["tw-flex tw-items-center",{"tw-mb-1.5":!t.minimal}])},[N("div",z,[(r(!0),c(D,null,T(l.participationLendersDisplayed,(p,u)=>(r(),V(k,{key:p.id,"lender-name":p.name,"lender-image-url":p.image.url,"is-small":"",class:d({"tw--ml-1":u>0,"tw-w-3 tw-h-3":!t.isChallenge,"tw-w-4 tw-h-4":t.isChallenge}),style:E({"z-index":l.participationLendersDisplayed.length-u})},null,8,["lender-name","lender-image-url","class","style"]))),128))]),t.minimal?P("",!0):(r(),c("p",F,j(l.supportText),1))],2)}const S=Z(L,[["render",H]]);L.__docgenInfo={displayName:"SupportedByLenders",exportName:"default",description:"",tags:{},props:[{name:"participants",type:{name:"object"},required:!0,defaultValue:{func:!1,value:"{}"}},{name:"isChallenge",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"minimal",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],sourceFiles:["/home/runner/work/ui/ui/src/components/BorrowerProfile/SupportedByLenders.vue"]};const x={lend:{loan:{lendingActions:{values:[{latestSharePurchaseDate:"2023-11-13T10:51:10Z",lender:{name:"Erica",image:{url:"https://www.development.kiva.org/img/s100/4d844ac2c0b77a8a522741b908ea5c32.jpg"}},shareAmount:"5.00",__typename:"LendingAction"},{latestSharePurchaseDate:"2023-11-08T02:32:20Z",lender:{name:"Joy",image:{url:"https://www.development.kiva.org/img/s100/4d844ac2c0b77a8a522741b908ea5c32.jpg"}},shareAmount:"25.00",__typename:"LendingAction"}],__typename:"LendingActionCollection"}}}},R={title:"Components/SupportedByLenders",component:S},m=a=>(t,{argTypes:n})=>({props:Object.keys(n),components:{SupportedByLenders:S,KvUserAvatar:A},setup(){return a},template:`
...
})`,...(C=(b=o.parameters)==null?void 0:b.docs)==null?void 0:C.source}}};const W=["Default","Empty","CurrentUserHighlighted"];export{o as CurrentUserHighlighted,s as Default,i as Empty,W as __namedExportsOrder,R as default};
