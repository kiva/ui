import{l as m}from"./entry-logReadQueryError-Codcl0QZ_g.js";import{r as k}from"./entry-settingsUtils-BglWvcCZaO.js";import{g}from"./entry-numeral-DJCTM12wUX.js";import{l as _}from"./entry-logFormatter-DhjghUk5Me.js";const E=`fragment experimentVersion on Experiment {
	id
	version
}
...
`,A=async(e,t)=>{try{return await e.mutate({mutation:K,variables:{preferences:JSON.stringify(t)}})}catch(n){m(n,"myKivaUtils createUserPreferencesMutation")}},I=async(e,t,n,a)=>{try{const r=JSON.stringify({...n,...a});return await e.mutate({mutation:U,variables:{updateUserPreferencesId:t.id,preferences:r}})}catch(r){m(r,"myKivaUtils updateUserPreferencesMutation")}},D=(e,t,n)=>{n&&t&&(e==null||e.set(y,"true",{path:"/"}))},O=e=>!!(e!=null&&e.get(y)),b=e=>{const t=new Date;t.setMonth(t.getMonth()+2),e==null||e.set("mykivaredirect","true",t)},T=(e,t,n,a,r,d)=>{let i={},c=!1;try{const s=(n==null?void 0:n.preferences)??"";i=s?JSON.parse(s):{},c=!!((i==null?void 0:i[p])??!1)}catch{_("getIsMyKivaEnabled JSON parsing exception","error")}if(c||a<M||r||O(d)){const{version:s}=e.readFragment({id:`Experiment:${f}`,fragment:v})??{},l=s==="b";if(x(e,t,"event-tracking",f,"EXP-MP-1235-Jan2025"),l&&!c&&typeof window<"u"&&typeof n<"u"){const o={[p]:1};n===null?A(e,o):I(e,n,i,o)}const u=c||l;return u&&b(d),u}return!1};export{C as A,q as M,v as _,V as a,T as g,D as s,x as t};
