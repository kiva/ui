import{g as S}from"./entry-index-CKVkeXup4D.js";import{p as M,t as U}from"./entry-time-left-mixin-C8HfaHj9He.js";import{F as O}from"./entry-FundraisingStatusMeter-Bs9Jpj3l1C.js";import{K as V}from"./entry-KvFlag-DKdInJLIR4.js";import{K as E}from"./entry-KvLoadingParagraph-Dqvtg0DcnR.js";import{n as F}from"./entry-numeral-BEwyVwpTZh.js";import{d as z}from"./entry-basketItems-BEDWpZvb7f.js";import{K as P}from"./entry-KvButton-DhvITnQFHx.js";import{K as W}from"./entry-KvIcon-CVvRd5jUJi.js";import{K as j}from"./entry-KvLoadingSpinner-M0Mow0PeQv.js";import{r as c,N as x,D as u,o as i,f as l,w as k,g as w,H as m,h as d,n as H,a as f,R as G,S as J,e as r,c as L,I as h,E as p}from"./entry-vue.esm-bundler-CCMUuEADRp.js";import{_ as I}from"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";import{w as R,c as B}from"./entry-exports-QxsLoHZpMP.js";import{B as X}from"./entry-mdi-Dz4iKpiukw.js";import{K as Y}from"./entry-KvMaterialIcon-D8DnGkc65h.js";import{K as Z}from"./entry-KvLoadingPlaceholder-BggctNa6n7.js";const C={name:"LendButton2",inject:["apollo","cookieStore"],props:{loanId:{type:Number,default:null},isInBasket:{type:Boolean,default:!1},isLentTo:{type:Boolean,default:!1},price:{type:[Number,String],default:25}},components:{KvButton:P,KvIcon:W,KvLoadingSpinner:j},data(){return{isAdding:!1}},computed:{state(){return this.isAdding?"adding":this.isInBasket?"basketed":this.isLentTo?"lent-to":"lend"},showLend(){return this.state==="lend"},showLendAgain(){return this.state==="lent-to"},showAdding(){return this.state==="adding"},showCheckout(){return this.state==="basketed"}},methods:{addToBasket(){const e=F(this.price).format("0.00");this.isAdding=!0,this.apollo.mutate({mutation:S`mutation addToBasket($loanId: Int!, $price: Money!, $basketId: String) {
				...
				}`,variables:{loanId:this.loanId,price:e},optimisticResponse:{__typename:"Mutation",shop:{__typename:"ShopMutation",updateLoanReservation:{__typename:"LoanReservation",id:this.loanId,price:e}}},awaitRefetchQueries:!0,refetchQueries:[{query:z,variables:{basketId:this.cookieStore.get("kvbskt")}}]}).then(t=>{this.isAdding=!1,t.error&&this.handleError(t.error)}).catch(t=>{this.isAdding=!1,this.handleError(t)})},handleError(e){console.error(e),this.$showTipMsg("There was a problem adding the loan to your basket","error");try{R(t=>{t.setTag("loan_id",this.loanId),B(e)})}catch{}}}},N=e=>(G("data-v-f80cb6b5"),e=e(),J(),e),$=N(()=>r("span",null,"Adding to Basket",-1)),ee=N(()=>r("span",null,"Checkout now",-1));function te(e,t,n,g,o,a){const s=c("kv-button"),_=c("kv-loading-spinner"),v=c("kv-icon"),y=x("kv-track-event");return a.showLend||a.showLendAgain?u((i(),l(s,{key:0,onClick:a.addToBasket,class:H({secondary:a.showLendAgain})},{default:k(()=>[a.showLend?w(e.$slots,"default",{key:0},()=>[m(" Lend now ")],!0):d("",!0),a.showLendAgain?w(e.$slots,"lent-to",{key:1},()=>[m(" Lend again ")],!0):d("",!0)],void 0),_:3},8,["onClick","class"])),[[y,["Lending","Add to basket","lend-button-click",n.loanId,n.loanId]]]):a.showAdding?(i(),l(s,{key:1,class:"lend-button__adding"},{default:k(()=>[w(e.$slots,"adding",{},()=>[f(_),$],!0)],void 0),_:3})):a.showCheckout?u((i(),l(s,{key:2,class:"secondary",to:"/basket"},{default:k(()=>[w(e.$slots,"checkout",{},()=>[f(v,{class:"icon",name:"checkmark"}),ee],!0)],void 0),_:3})),[[y,["Lending","click-Read more","checkout-now-button-click",n.loanId,n.loanId]]]):d("",!0)}const ae=I(C,[["render",te],["__scopeId","data-v-f80cb6b5"]]);C.__docgenInfo={displayName:"LendButton2",exportName:"default",description:"",tags:{},props:[{name:"loanId",type:{name:"number"},defaultValue:{func:!1,value:"null"}},{name:"isInBasket",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"isLentTo",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"price",type:{name:"number|string"},defaultValue:{func:!1,value:"25"}}],slots:[{name:"default"},{name:"lent-to"},{name:"adding"},{name:"checkout"}],sourceFiles:["/home/runner/work/ui/ui/src/components/LoanCards/Buttons/LendButton2.vue"]};const A={name:"WhySpecial",props:{text:{type:String,required:!0}},components:{KvMaterialIcon:Y},data(){return{mdiStar:X}}},ne={class:"tw-flex tw-items-stretch tw-flex-nowrap tw-overflow-hidden tw-border tw-border-tertiary tw-rounded tw-w-full tw-mb-2"},oe={class:"tw-bg-tertiary tw-p-1 tw-flex-shrink-0 tw-flex tw-items-center"},re={class:"tw-bg-primary tw-p-2 tw-flex-1"},se=r("strong",null,"This loan is special because",-1);function ie(e,t,n,g,o,a){const s=c("kv-material-icon");return i(),L("div",ne,[r("div",oe,[f(s,{icon:o.mdiStar,class:"tw-w-3 tw-h-3 tw-fill-current tw-text-primary-inverse"},null,8,["icon"])]),r("p",re,[se,m(" "+h(n.text),1)])])}const le=I(A,[["render",ie]]);A.__docgenInfo={displayName:"WhySpecial",exportName:"default",description:"",tags:{},props:[{name:"text",type:{name:"string"},required:!0}],sourceFiles:["/home/runner/work/ui/ui/src/components/LoanCards/WhySpecial.vue"]};const b=S`query recLoanCard($basketId: String, $loanId: Int!) {
	shop (basketId: $basketId) {
		id
		basket {
			id
