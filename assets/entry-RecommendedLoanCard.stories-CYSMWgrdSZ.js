import{g as j}from"./entry-index-CWclSTHHJk.js";import{p as Z}from"./entry-percent-raised-mixin-DA869t-Oxs.js";import{t as G}from"./entry-time-left-mixin-BIGZ3cp_bt.js";import{F as H}from"./entry-FundraisingStatusMeter-FWME7yfYK-.js";import{K as J}from"./entry-KvLoadingParagraph-b8Fmh92Ska.js";import{n as X}from"./entry-numeral-xVHG5DEP0A.js";import{_ as Y}from"./entry-basketItems-B-09YWrzPC.js";import{_ as $}from"./entry-updateLoanReservation-BaDuxVurTB.js";import{_ as ee}from"./entry-KvButton-C-O0AgbWwS.js";import{K as te}from"./entry-KvIcon-D5ZyAcTyJs.js";import{K as ne}from"./entry-KvLoadingSpinner-o64Xwsxfy_.js";import{b as u,f as c,e as w,n as ae,g as l,I as T,h as d,o as i,B as y,j as m,d as h,a as r,c as b,t as _,D as f}from"./entry-vue.esm-bundler-ED6DvobC3-.js";import{_ as x}from"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";import{w as D,a as O}from"./entry-exports-CudK1O5XNw.js";import{g as oe}from"./entry-mdi-BeeDX8vtDa.js";import{x as re}from"./entry-KvMaterialIcon-BM2HtuQNzV.js";import{b as se}from"./entry-KvFlag-Dvow2uVCUp.js";import{_ as ie}from"./entry-KvLoadingPlaceholder-BIZZosYllW.js";import{a as Q}from"./entry-apollo-story-mixin-Be98L1yqJn.js";import{c as V}from"./entry-cookie-store-story-mixin-Bv_t57ys9l.js";import"./entry-index-B2fPe4RJm7.js";import"./entry-index-COmIkRYU2t.js";import"./entry-index-C7qYbrGKZY.js";import"./entry-index-D4S0JsTkt8.js";import"./entry-index-CN90oFOzzG.js";import"./entry-index-CbPSoDvqj7.js";import"./entry-index-DrXNim1j4v.js";import"./entry-index-D39skEuOvm.js";import"./entry-index-D_23gIjsxn.js";import"./entry-getCacheKey-DzwUUocZCb.js";import"./entry-_commonjsHelpers-Cpj98o6Yn6.js";import"./iframe-DmiUPxZA.js";import"./entry-_plugin-vue_export-helper-9uN0dvLoeT.js";const U={name:"LendButton2",inject:["apollo","cookieStore"],props:{loanId:{type:Number,default:null},isInBasket:{type:Boolean,default:!1},isLentTo:{type:Boolean,default:!1},price:{type:[Number,String],default:25}},components:{KvButton:ee,KvIcon:te,KvLoadingSpinner:ne},data(){return{isAdding:!1}},computed:{state(){return this.isAdding?"adding":this.isInBasket?"basketed":this.isLentTo?"lent-to":"lend"},showLend(){return this.state==="lend"},showLendAgain(){return this.state==="lent-to"},showAdding(){return this.state==="adding"},showCheckout(){return this.state==="basketed"}},methods:{addToBasket(){const e=X(this.price).format("0.00");this.isAdding=!0,this.apollo.mutate({mutation:$,variables:{loanId:this.loanId,price:e},optimisticResponse:{__typename:"Mutation",shop:{__typename:"ShopMutation",updateLoanReservation:{__typename:"LoanReservation",id:this.loanId,price:e}}},awaitRefetchQueries:!0,refetchQueries:[{query:Y,variables:{basketId:this.cookieStore.get("kvbskt")}}]}).then(t=>{this.isAdding=!1,t.error&&this.handleError(t.error)}).catch(t=>{this.isAdding=!1,this.handleError(t)})},handleError(e){console.error(e),this.$showTipMsg("There was a problem adding the loan to your basket","error");try{D(t=>{t.setTag("loan_id",this.loanId),O(e)})}catch{}}}};function le(e,t,a,g,o,n){const s=d("kv-button"),p=d("kv-loading-spinner"),I=d("kv-icon"),k=T("kv-track-event");return n.showLend||n.showLendAgain?u((i(),c(s,{key:0,onClick:n.addToBasket,class:ae({secondary:n.showLendAgain})},{default:w(()=>[n.showLend?y(e.$slots,"default",{key:0},()=>[t[0]||(t[0]=m(" Lend now "))],!0):l("",!0),n.showLendAgain?y(e.$slots,"lent-to",{key:1},()=>[t[1]||(t[1]=m(" Lend again "))],!0):l("",!0)],void 0),_:3},8,["onClick","class"])),[[k,["Lending","Add to basket","lend-button-click",a.loanId,a.loanId]]]):n.showAdding?(i(),c(s,{key:1,class:"lend-button__adding"},{default:w(()=>[y(e.$slots,"adding",{},()=>[h(p),t[2]||(t[2]=r("span",null,"Adding to Basket",-1))],!0)],void 0),_:3})):n.showCheckout?u((i(),c(s,{key:2,class:"secondary",to:"/basket"},{default:w(()=>[y(e.$slots,"checkout",{},()=>[h(I,{class:"icon",name:"checkmark"}),t[3]||(t[3]=r("span",null,"Checkout now",-1))],!0)],void 0),_:3})),[[k,["Lending","click-Read more","checkout-now-button-click",a.loanId,a.loanId]]]):l("",!0)}const de=x(U,[["render",le],["__scopeId","data-v-1f6fe4e1"]]);U.__docgenInfo={displayName:"LendButton2",exportName:"default",description:"",tags:{},props:[{name:"loanId",type:{name:"number"},defaultValue:{func:!1,value:"null"}},{name:"isInBasket",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"isLentTo",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"price",type:{name:"number|string"},defaultValue:{func:!1,value:"25"}}],slots:[{name:"default"},{name:"lent-to"},{name:"adding"},{name:"checkout"}],sourceFiles:["/home/runner/work/ui/ui/src/components/LoanCards/Buttons/LendButton2.vue"]};const K={name:"WhySpecial",props:{text:{type:String,required:!0}},components:{KvMaterialIcon:re},data(){return{mdiStar:oe}}},ce={class:"tw-flex tw-items-stretch tw-flex-nowrap tw-overflow-hidden tw-border tw-border-tertiary tw-rounded tw-w-full tw-mb-2"},ue={class:"tw-bg-tertiary tw-p-1 tw-flex-shrink-0 tw-flex tw-items-center"},me={class:"tw-bg-primary tw-p-2 tw-flex-1"};function pe(e,t,a,g,o,n){const s=d("kv-material-icon");return i(),b("div",ce,[r("div",ue,[h(s,{icon:o.mdiStar,class:"tw-w-3 tw-h-3 tw-fill-current tw-text-primary-inverse"},null,8,["icon"])]),r("p",me,[t[0]||(t[0]=r("strong",null,"This loan is special because",-1)),m(" "+_(a.text),1)])])}const _e=x(K,[["render",pe]]);K.__docgenInfo={displayName:"WhySpecial",exportName:"default",description:"",tags:{},props:[{name:"text",type:{name:"string"},required:!0}],sourceFiles:["/home/runner/work/ui/ui/src/components/LoanCards/WhySpecial.vue"]};const S=j`query recLoanCard($basketId: String, $loanId: Int!) {
    ...
    `});var R,A,B;v.parameters={...v.parameters,docs:{...(R=v.parameters)==null?void 0:R.docs,source:{originalSource:`() => ({
  ...
  template: \`
    ...
    \`
})`,...(B=(A=v.parameters)==null?void 0:A.docs)==null?void 0:B.source}}};var q,M,N;L.parameters={...L.parameters,docs:{...(q=L.parameters)==null?void 0:q.docs,source:{originalSource:`() => ({
  mixins: [apolloStoryMixin({
    loading: true
  }), cookieStoreStoryMixin()],
  components: {
  ...
  template: \`
    ...
    \`
})`,...(N=(M=L.parameters)==null?void 0:M.docs)==null?void 0:N.source}}};const ct=["Default","Loading"];export{v as Default,L as Loading,ct as __namedExportsOrder,dt as default};
