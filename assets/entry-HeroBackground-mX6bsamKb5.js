import{g as E}from"./entry-index-CWclSTHHJk.js";import{c as G,d as J,h as O,o as Q}from"./entry-vue.esm-bundler-CkX4CbCAj4.js";import"./entry-KvWwwHeaderBasic-Bdr4KQ5mw1.js";import"./entry-tailwind.config-CSFvy6LGkL.js";import R from"./entry-KvContentfulImg--vzRuNxxKf.js";import"./entry-numeral-xVHG5DEP0A.js";import{_ as U}from"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";const D={name:"HeroBackground",inject:["apollo","cookieStore"],components:{KvContentfulImg:R},props:{loanId:{type:Number,default:0},statusCard:{type:Boolean,default:!1}},data(){return{contentfulAlt:"",contentfulSrc:"",isoCode:"",stateCode:"",city:"",placeholderKey:"bp-hero-country-placeholder",sourceSizes:[{width:1920,height:460,media:"min-width: 1024px"},{width:1024,height:320,media:"min-width: 734px"}]}},computed:{cityKey(){return`${this.stateKey}-${this.city.toLowerCase()}`},stateKey(){return`${this.countryKey}-${this.stateCode.toLowerCase()}`},countryKey(){return`bp-hero-country-${this.isoCode.toLowerCase()}`}},apollo:{query:E`
