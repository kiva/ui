...
\`\`\``,type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"checked",description:'Native checked attribute. Used to select the radio if you\'re not using v-model E.g.,\n```\n <KvRadio value="foo" :checked="myModel === foo">Foo</KvRadio>\n <KvRadio value="bar" :checked="myModel === bar">Bar</KvRadio>\n```',type:{name:"string|number|boolean"},defaultValue:{func:!1,value:"false"}},{name:"v-model",type:{name:"string|number|boolean"},defaultValue:{func:!1,value:"false"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/ui/ui/node_modules/@kiva/kv-components/vue/KvRadio.vue"]};export{T as K};
