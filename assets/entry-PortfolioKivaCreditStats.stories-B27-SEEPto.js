...
`,rt={title:"Page/Portfolio/Kiva Credit Stats",component:c},w=()=>({components:{KivaCreditStats:c,KvGrid:d,KvPageContainer:u},mixins:[p({loading:!0}),f()],template:v}),x=()=>({components:{KivaCreditStats:c,KvGrid:d,KvPageContainer:u},mixins:[p({queryResult:g("25.00","25.00")}),f()],template:v}),S=()=>({components:{KivaCreditStats:c,KvGrid:d,KvPageContainer:u},mixins:[p({queryResult:g("0.00","0.00")}),f()],template:v}),b=()=>({components:{KivaCreditStats:c,KvGrid:d,KvPageContainer:u},mixins:[p({queryResult:g("50.00","0.00")}),f()],template:v}),K=()=>({components:{KivaCreditStats:c,KvGrid:d,KvPageContainer:u},mixins:[p({queryResult:g("0.00","75.00")}),f()],template:v}),C=()=>({components:{KivaCreditStats:c,KvGrid:d,KvPageContainer:u},mixins:[p({queryResult:g("856235.57","2346.67")}),f()],template:v}),k=()=>({components:{KivaCreditStats:c,KvGrid:d,KvPageContainer:u},mixins:[p({queryResult:g("8662.00","35752.45")}),f()],template:v});var $,F,R;w.parameters={...w.parameters,docs:{...($=w.parameters)==null?void 0:$.docs,source:{originalSource:`() => ({
  ...
  template
})`,...(oe=(te=k.parameters)==null?void 0:te.docs)==null?void 0:oe.source}}};const lt=["Loading","OneLoanOneDeposit","NoLoansNoDeposits","LoansWithNoDeposits","DepositsWithNoLoans","MoreLoansThanDeposits","MoreDepositsThanLoans"];export{K as DepositsWithNoLoans,w as Loading,b as LoansWithNoDeposits,k as MoreDepositsThanLoans,C as MoreLoansThanDeposits,S as NoLoansNoDeposits,x as OneLoanOneDeposit,lt as __namedExportsOrder,rt as default};
