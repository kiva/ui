import{g as S}from"./entry-index-DGXt1zOePE.js";import{p as M,t as U}from"./entry-time-left-mixin-C8HfaHj9He.js";import{F as O}from"./entry-FundraisingStatusMeter-BW8_UekkPR.js";import{K as V}from"./entry-KvLoadingParagraph-CBd7zbkufO.js";import{n as F}from"./entry-numeral-CmvrP3KSIW.js";import{d as E}from"./entry-basketItems-BEDWpZvb7f.js";import{K as z}from"./entry-KvButton-B_o7EklNFh.js";import{K as P}from"./entry-KvIcon-DW7toGGp4u.js";import{K as W}from"./entry-KvLoadingSpinner-gZfVFu-I0Y.js";import{r as d,H as x,D as u,o as i,f as c,w as k,g as w,E as m,h as l,n as j,a as p,R as G,S as H,e as r,c as v,F as h,J as f}from"./entry-vue.esm-bundler-CTwdbZZHjD.js";import{_ as I}from"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";import{w as R,a as B}from"./entry-exports-CudK1O5XNw.js";import{w as J,G as X}from"./entry-KvMaterialIcon-Do7tkng7tH.js";import"./entry-KvWideLoanCard-UZGuFHBpxm.js";import{_ as Y}from"./entry-KvLoadingPlaceholder-CnqSL29y3V.js";import{j as Z}from"./entry-KvFlag-lZVBmgJ76S.js";const C={name:"LendButton2",inject:["apollo","cookieStore"],props:{loanId:{type:Number,default:null},isInBasket:{type:Boolean,default:!1},isLentTo:{type:Boolean,default:!1},price:{type:[Number,String],default:25}},components:{KvButton:z,KvIcon:P,KvLoadingSpinner:W},data(){return{isAdding:!1}},computed:{state(){return this.isAdding?"adding":this.isInBasket?"basketed":this.isLentTo?"lent-to":"lend"},showLend(){return this.state==="lend"},showLendAgain(){return this.state==="lent-to"},showAdding(){return this.state==="adding"},showCheckout(){return this.state==="basketed"}},methods:{addToBasket(){const e=F(this.price).format("0.00");this.isAdding=!0,this.apollo.mutate({mutation:S`mutation addToBasket($loanId: Int!, $price: Money!, $basketId: String) {
