import{g as u}from"./entry-index-CKVkeXup4D.js";import{a as X,o as G,b as W,d as Z}from"./entry-vue.esm-bundler-Bbq66B_iPn.js";import"./entry-KvWideLoanCard-ac7XPc0PbW.js";import"./entry-numeral-BEwyVwpTZh.js";import ee from"./entry-KvContentfulImg-euStQvIYwX.js";import{_ as te}from"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";import{d as ne}from"./entry-experimentVersion-DPC15KwAMV.js";import{l as Y}from"./entry-logReadQueryError-Codcl0QZ_g.js";import{t as ie}from"./entry-experimentUtils-CZhauzP3sM.js";import{l as oe}from"./entry-logFormatter-DhjghUk5Me.js";const Q={name:"HeroBackground",inject:["apollo","cookieStore"],components:{KvContentfulImg:ee},props:{loanId:{type:Number,default:0}},data(){return{contentfulAlt:"",contentfulSrc:"",isoCode:"",stateCode:"",city:"",placeholderKey:"bp-hero-country-placeholder",sourceSizes:[{width:1920,height:460,media:"min-width: 1024px"},{width:1024,height:320,media:"min-width: 734px"}]}},computed:{cityKey(){return`${this.stateKey}-${this.city.toLowerCase()}`},stateKey(){return`${this.countryKey}-${this.stateCode.toLowerCase()}`},countryKey(){return`bp-hero-country-${this.isoCode.toLowerCase()}`}},apollo:{query:u`
