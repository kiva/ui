import{n as r}from"./entry-numeral-xVHG5DEP0A.js";import{l as u}from"./entry-logFormatter-C3zJjaAqCL.js";import{_ as o}from"./entry-basketCount-CZ-kE9ye_Z.js";import{_ as c}from"./entry-basketItems-B-09YWrzPC.js";import{_ as k}from"./entry-updateLoanReservation-BaDuxVurTB.js";import{w as v,a as g}from"./entry-exports-CudK1O5XNw.js";const N=`query basketLoansInfo(
	$id: Int!
...
`,p={kind:"Document",definitions:[{kind:"OperationDefinition",operation:"mutation",name:{kind:"Name",value:"createNewBasket"},variableDefinitions:[],directives:[],selectionSet:{kind:"SelectionSet",selections:[{kind:"Field",name:{kind:"Name",value:"shop"},arguments:[],directives:[],selectionSet:{kind:"SelectionSet",selections:[{kind:"Field",name:{kind:"Name",value:"id"},arguments:[],directives:[]},{kind:"Field",name:{kind:"Name",value:"createBasket"},arguments:[],directives:[]}]}}]}}],loc:{start:0,end:98,source:{name:"GraphQL request",locationOffset:{line:1,column:1},body:f}}},w="invalidBasket";function l(i,n){u(n,"error");try{v(e=>{e.setTag("loan_id",i),e.setTag("mutation","addToBasket"),g(n)})}catch{}}async function D({apollo:i,cookieStore:n}){var d;const{data:e}=await i.mutate({mutation:p}),t=(d=e==null?void 0:e.shop)==null?void 0:d.createBasket;return t&&n.set("kvbskt",t,{path:"/",secure:!0}),t}function V({amount:i,apollo:n,loanId:e}){return new Promise((t,d)=>{const m=r(i).format("0.00");n.mutate({mutation:k,variables:{loanId:e,price:m},optimisticResponse:{__typename:"Mutation",shop:{id:"0",__typename:"ShopMutation",updateLoanReservation:{__typename:"LoanReservation",id:e,price:m}}},awaitRefetchQueries:!0,refetchQueries:[{query:o},{query:c},{query:S,variables:{id:e}}]}).then(a=>{a.errors?(a.errors.forEach(s=>{l(e,s)}),d(a.errors)):t()}).catch(a=>{(Array.isArray(a)?a:[a]).forEach(s=>{l(e,s)}),d(a)})})}function B({loan:i,cookieStore:n}){n.remove("kvbskt",{path:"/",secure:!0}),n.set("kvatbid",JSON.stringify(i)),window.location.reload()}function z(i){return["shop.invalidBasketId","shop.basketRequired"].includes(i)}export{w as I,B as a,D as c,z as h,V as s};
