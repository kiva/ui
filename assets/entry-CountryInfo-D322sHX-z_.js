import{g as A}from"./entry-index-CWclSTHHJk.js";import{n as I}from"./entry-numeral-xVHG5DEP0A.js";import{c as l,a as t,d,F as v,r as x,t as i,g as y,f as L,e as k,h as F,o as r,j as N}from"./entry-vue.esm-bundler-CkX4CbCAj4.js";import{y as R,_ as V}from"./entry-KvWwwHeaderBasic-Bdr4KQ5mw1.js";import"./entry-tailwind.config-CSFvy6LGkL.js";import{_ as M}from"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";const B={name:"CountryInfo",inject:["apollo","cookieStore"],components:{KvLoadingPlaceholder:V,KvUiButton:R},props:{loanId:{type:Number,default:0}},data(){return{avgAnnualIncome:"",countryIsoCode:"",countryName:"",fundsLentInCountry:0,loanCurrency:"",loanCurrencyFullName:"",loading:!0,loansInRegionLink:"",numLoansFundraising:0,regionName:""}},apollo:{lazy:!0,query:A`query borrowerCountryInfo($loanId: Int!) {
			lend {
				loan(id: $loanId) {
					id
					terms {
