import{T as p}from"./entry-TeamMessageCard-Cpg8mDqN7S.js";import"./entry-vue.esm-bundler-ED6DvobC3-.js";import"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";import"./entry-index-tAHLmhMYuW.js";import"./entry-index-RkAYAUfJHC.js";import"./entry-index-COmIkRYU2t.js";import"./entry-index-BwE6orlohw.js";import"./entry-index-DDCoMUF_Su.js";import"./entry-index-B7Y4crKsa-.js";import"./entry-index-D39skEuOvm.js";import"./entry-index-D_23gIjsxn.js";import"./entry-index-BA7RGigQ8D.js";import"./entry-index-D4S0JsTkt8.js";const j={title:"LendingTeams/TeamMessageCard",component:p},g=t=>{const a=(c,{argTypes:l})=>({props:Object.keys(l),components:{TeamMessageCard:p},setup(){return t},template:`
            <div style="max-width: 360px;">
                <team-message-card :message="message" />
            </div>
        `});return a.args=t,a},e=g({message:{id:1001,body:"Great work everyone! We just hit our monthly lending goal. Keep it up! #1002",date:new Date(Date.now()-2*60*60*1e3).toISOString(),sender:{id:42,name:"Jane Doe",publicId:"jane_doe",imageUrl:"https://www-0.development.kiva.org/img/s100/26e15431f51b540f31cd9f011cc54f31.jpg"},team:{id:101,name:"Kiva Friends",teamPublicId:"kiva-friends",imageUrl:"https://www-0.development.kiva.org/img/s100/team_s135.png"}}}),n=g({message:{id:1002,body:"Welcome to the team, everyone! Happy to lend together.",date:new Date(Date.now()-24*60*60*1e3).toISOString(),sender:{id:43,name:"Anonymous Lender",publicId:"anonymous_lender",imageUrl:""},team:{id:101,name:"Kiva Friends",teamPublicId:"kiva-friends",imageUrl:"https://www-0.development.kiva.org/img/s100/team_s135.png"}}});var r,o,s;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`story({
  message: {
    id: 1001,
...
})`,...(d=(i=n.parameters)==null?void 0:i.docs)==null?void 0:d.source}}};const K=["Default","NoSenderImage"];export{e as Default,n as NoSenderImage,K as __namedExportsOrder,j as default};
