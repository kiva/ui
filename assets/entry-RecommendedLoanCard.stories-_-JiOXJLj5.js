import{g as j}from"./entry-index-CWclSTHHJk.js";import{p as J}from"./entry-percent-raised-mixin-DA869t-Oxs.js";import{t as Z}from"./entry-time-left-mixin-Da0n0H4KJu.js";import{F as G}from"./entry-FundraisingStatusMeter-DiUjznBtbc.js";import{K as H}from"./entry-KvLoadingParagraph-B2fSmvMRzt.js";import{n as X}from"./entry-numeral-xVHG5DEP0A.js";import{_ as Y}from"./entry-basketItems-B-09YWrzPC.js";import{_ as $}from"./entry-updateLoanReservation-BaDuxVurTB.js";import{_ as ee}from"./entry-KvButton-CJvTE5Ko7G.js";import{K as te}from"./entry-KvIcon-BpdFV3NDzd.js";import{K as ne}from"./entry-KvLoadingSpinner-CLQMwIA_4S.js";import{b as u,f as c,e as w,n as ae,g as l,M as T,h as d,o as i,E as y,j as m,d as h,a as r,c as b,t as _,J as f}from"./entry-vue.esm-bundler-CkX4CbCAj4.js";import{_ as x}from"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";import{w as D,a as O}from"./entry-exports-CudK1O5XNw.js";import{x as oe,i as re,_ as se}from"./entry-KvWwwHeaderBasic-BXEr46oeHh.js";import"./entry-tailwind.config-CSFvy6LGkL.js";import{b as ie}from"./entry-KvFlag-CpYzKKu2EP.js";import{a as Q}from"./entry-apollo-story-mixin-Be98L1yqJn.js";import{c as V}from"./entry-cookie-store-story-mixin-Bv_t57ys9l.js";import"./entry-index-DY-WJZJV9t.js";import"./entry-index-DZ6tDFr9r-.js";import"./entry-getCacheKey-n-S9GzCBTJ.js";import"./entry-_commonjsHelpers-Cpj98o6Yn6.js";import"./iframe-B1d9Jrgq.js";import"./entry-index-XKsyWbakvl.js";const U={name:"LendButton2",inject:["apollo","cookieStore"],props:{loanId:{type:Number,default:null},isInBasket:{type:Boolean,default:!1},isLentTo:{type:Boolean,default:!1},price:{type:[Number,String],default:25}},components:{KvButton:ee,KvIcon:te,KvLoadingSpinner:ne},data(){return{isAdding:!1}},computed:{state(){return this.isAdding?"adding":this.isInBasket?"basketed":this.isLentTo?"lent-to":"lend"},showLend(){return this.state==="lend"},showLendAgain(){return this.state==="lent-to"},showAdding(){return this.state==="adding"},showCheckout(){return this.state==="basketed"}},methods:{addToBasket(){const e=X(this.price).format("0.00");this.isAdding=!0,this.apollo.mutate({mutation:$,variables:{loanId:this.loanId,price:e},optimisticResponse:{__typename:"Mutation",shop:{__typename:"ShopMutation",updateLoanReservation:{__typename:"LoanReservation",id:this.loanId,price:e}}},awaitRefetchQueries:!0,refetchQueries:[{query:Y,variables:{basketId:this.cookieStore.get("kvbskt")}}]}).then(t=>{this.isAdding=!1,t.error&&this.handleError(t.error)}).catch(t=>{this.isAdding=!1,this.handleError(t)})},handleError(e){console.error(e),this.$showTipMsg("There was a problem adding the loan to your basket","error");try{D(t=>{t.setTag("loan_id",this.loanId),O(e)})}catch{}}}};function le(e,t,a,g,o,n){const s=d("kv-button"),p=d("kv-loading-spinner"),I=d("kv-icon"),k=T("kv-track-event");return n.showLend||n.showLendAgain?u((i(),c(s,{key:0,onClick:n.addToBasket,class:ae({secondary:n.showLendAgain})},{default:w(()=>[n.showLend?y(e.$slots,"default",{key:0},()=>[t[0]||(t[0]=m(" Lend now "))],!0):l("",!0),n.showLendAgain?y(e.$slots,"lent-to",{key:1},()=>[t[1]||(t[1]=m(" Lend again "))],!0):l("",!0)],void 0),_:3},8,["onClick","class"])),[[k,["Lending","Add to basket","lend-button-click",a.loanId,a.loanId]]]):n.showAdding?(i(),c(s,{key:1,class:"lend-button__adding"},{default:w(()=>[y(e.$slots,"adding",{},()=>[h(p),t[2]||(t[2]=r("span",null,"Adding to Basket",-1))],!0)],void 0),_:3})):n.showCheckout?u((i(),c(s,{key:2,class:"secondary",to:"/basket"},{default:w(()=>[y(e.$slots,"checkout",{},()=>[h(I,{class:"icon",name:"checkmark"}),t[3]||(t[3]=r("span",null,"Checkout now",-1))],!0)],void 0),_:3})),[[k,["Lending","click-Read more","checkout-now-button-click",a.loanId,a.loanId]]]):l("",!0)}const de=x(U,[["render",le],["__scopeId","data-v-1f6fe4e1"]]);U.__docgenInfo={displayName:"LendButton2",exportName:"default",description:"",tags:{},props:[{name:"loanId",type:{name:"number"},defaultValue:{func:!1,value:"null"}},{name:"isInBasket",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"isLentTo",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"price",type:{name:"number|string"},defaultValue:{func:!1,value:"25"}}],slots:[{name:"default"},{name:"lent-to"},{name:"adding"},{name:"checkout"}],sourceFiles:["/home/runner/work/ui/ui/src/components/LoanCards/Buttons/LendButton2.vue"]};const E={name:"WhySpecial",props:{text:{type:String,required:!0}},components:{KvMaterialIcon:oe},data(){return{mdiStar:re}}},ce={class:"tw-flex tw-items-stretch tw-flex-nowrap tw-overflow-hidden tw-border tw-border-tertiary tw-rounded tw-w-full tw-mb-2"},ue={class:"tw-bg-tertiary tw-p-1 tw-flex-shrink-0 tw-flex tw-items-center"},me={class:"tw-bg-primary tw-p-2 tw-flex-1"};function pe(e,t,a,g,o,n){const s=d("kv-material-icon");return i(),b("div",ce,[r("div",ue,[h(s,{icon:o.mdiStar,class:"tw-w-3 tw-h-3 tw-fill-current tw-text-primary-inverse"},null,8,["icon"])]),r("p",me,[t[0]||(t[0]=r("strong",null,"This loan is special because",-1)),m(" "+_(a.text),1)])])}const _e=x(E,[["render",pe]]);E.__docgenInfo={displayName:"WhySpecial",exportName:"default",description:"",tags:{},props:[{name:"text",type:{name:"string"},required:!0}],sourceFiles:["/home/runner/work/ui/ui/src/components/LoanCards/WhySpecial.vue"]};const S=j`query recLoanCard($basketId: String, $loanId: Int!) {
    ...
    `});var R,A,M;v.parameters={...v.parameters,docs:{...(R=v.parameters)==null?void 0:R.docs,source:{originalSource:`() => ({
  ...
  template: \`
    ...
    \`
})`,...(M=(A=v.parameters)==null?void 0:A.docs)==null?void 0:M.source}}};var q,B,N;L.parameters={...L.parameters,docs:{...(q=L.parameters)==null?void 0:q.docs,source:{originalSource:`() => ({
  mixins: [apolloStoryMixin({
    loading: true
  }), cookieStoreStoryMixin()],
  components: {
  ...
  template: \`
    ...
    \`
})`,...(N=(B=L.parameters)==null?void 0:B.docs)==null?void 0:N.source}}};const nt=["Default","Loading"];export{v as Default,L as Loading,nt as __namedExportsOrder,tt as default};
