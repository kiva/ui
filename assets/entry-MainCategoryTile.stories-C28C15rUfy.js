import{K as F}from"./entry-KvResponsiveImage-DJkk0Fu_7v.js";import{c as w,d as v,E as f,I as G,f as k,b as _,r as S,o as s,a as I,e as a,G as i,n as P}from"./entry-vue.esm-bundler-6I7BZrzll1.js";import{_ as q}from"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";import"./entry-KvWwwHeader-Bel1ZjvP0X.js";import{g as R}from"./entry-KvGrid-oENhproIuL.js";import"./entry-numeral-DJCTM12wUX.js";import{x as W}from"./entry-KvPageContainer-xzjjhUXVBi.js";import"./entry-throttle-DL1zg7kAk0.js";import"./entry-_commonjsHelpers-Cpj98o6Yn6.js";import"./entry-isSymbol-5pnFTpIKM9.js";import"./entry-toNumber-MeiYJWOH0A.js";const j={name:"MainCategoryTile",props:{tileSize:{type:String,default:"small",validator:t=>["small","medium","large"].indexOf(t)!==-1},categoryName:{type:String,default:""},categoryDescription:{type:String,default:""},numberLoans:{type:Number,default:0},image:{type:String,default:""},retinaImage:{type:String,default:""},categoryUrl:{type:String,default:""}},components:{KvResponsiveImage:F},data(){return{}},computed:{retinaImageExists(){return this.retinaImage!==""},altText(){return`Kiva loans to ${this.categoryName}`},cleanURL(){return this.categoryUrl.substring(this.categoryUrl.lastIndexOf("/")+1)}},methods:{chooseImage(t){return t==="large"?this.retinaImageExists?[["small",this.retinaImage],["small retina",this.retinaImage]]:[["small",this.image]]:t==="medium"?this.retinaImageExists?[["small",this.retinaImage],["small retina",this.retinaImage],["large",this.image],["large retina",this.retinaImage]]:[["small",this.image]]:this.retinaImageExists?[["small",this.image],["small retina",this.retinaImage]]:[["small",this.image]]}}},A={key:0,class:"tw-mb-6 tw-group","data-testid":"all-categories-tiles"},J={class:"tw-text-center tw-flex tw-justify-between"},Q={class:"tw-mt-2 tw-mb-2 group-hover:tw-underline"},X={class:"tw-line-clamp-3"},Y={key:0,class:"tw-mt-1 tw-mb-2 tw-hidden md:tw-block"},Z={key:1,class:"tw-mb-6 tw-group","data-testid":"all-categories-tiles"},$={class:"tw-flex"},ee={class:"tw-mr-2 tw-flex-none"},ae={class:"tw-grow"},te={class:"tw-mb-2 group-hover:tw-underline"},ie={class:"tw-line-clamp-2"},re={class:"tw-mt-1 tw-mb-1"};function ne(t,r,e,o,oe,n){const y=S("kv-responsive-image"),h=S("router-link"),b=G("kv-track-event");return e.tileSize==="large"||e.tileSize==="medium"?(s(),w("div",A,[f((s(),k(h,{class:"remove-link-decoration",to:`/lend-by-category/${n.cleanURL}`},{default:_(()=>[I(y,{class:"category-image category-image__large",images:n.chooseImage(e.tileSize),loading:"lazy",alt:n.altText},null,8,["images","alt"]),a("div",null,[a("div",J,[a("h3",Q,i(e.categoryName),1),a("h4",{class:P(["tw-mt-2 tw-mb-2",e.tileSize==="medium"?"md:tw-hidden":""])},i(e.numberLoans)+" loans ",3)]),a("div",null,[a("p",X,i(e.categoryDescription),1)])]),e.tileSize==="medium"?(s(),w("h4",Y,i(e.numberLoans)+" loans ",1)):v("",!0)],void 0),_:1},8,["to"])),[[b,["Lending","click-Category",e.categoryName]]])])):e.tileSize==="small"?(s(),w("div",Z,[f((s(),k(h,{class:"remove-link-decoration",to:`/lend-by-category/${n.cleanURL}`},{default:_(()=>[a("div",$,[a("div",ee,[I(y,{class:"category-image category-image__small",images:n.chooseImage(e.tileSize),loading:"lazy",alt:n.altText},null,8,["images","alt"])]),a("div",ae,[a("h3",te,i(e.categoryName),1),a("div",null,[a("span",ie,i(e.categoryDescription),1)]),a("h4",re,i(e.numberLoans)+" loans ",1)])])],void 0),_:1},8,["to"])),[[b,["Lending","click-Category",e.categoryName]]])])):v("",!0)}const p=q(j,[["render",ne],["__scopeId","data-v-59219025"]]);j.__docgenInfo={displayName:"MainCategoryTile",exportName:"default",description:"",tags:{},props:[{name:"tileSize",type:{name:"string"},defaultValue:{func:!1,value:"'small'"}},{name:"categoryName",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"categoryDescription",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"numberLoans",type:{name:"number"},defaultValue:{func:!1,value:"0"}},{name:"image",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"retinaImage",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"categoryUrl",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],sourceFiles:["/home/runner/work/ui/ui/src/components/Categories/MainCategoryTile.vue"]};const ve={title:"Components/Main Category Tile",component:p,args:{tileSize:"small",numberTiles:3},argTypes:{tileSize:{control:{type:"select"},options:["small","medium","large"]}}},u=(t={})=>{const r=(e,{argTypes:o})=>({props:Object.keys(o),components:{MainCategoryTile:p,KvGrid:R,KvPageContainer:W},setup(){return t},template:`
            <kv-page-container>
        ...
        `});return r.args=t,r},se=(t={})=>{const r=(e,{argTypes:o})=>({props:Object.keys(o),components:{MainCategoryTile:p,KvGrid:R,KvPageContainer:W},setup(){return t},template:`
            <kv-page-container>
                <kv-grid class="tw-grid-cols-12">
...
})`,...(M=(T=l.parameters)==null?void 0:T.docs)==null?void 0:M.source}}};var V,H,E;g.parameters={...g.parameters,docs:{...(V=g.parameters)==null?void 0:V.docs,source:{originalSource:`story({
  tileSize: 'small',
  categoryName: 'Health',
...
})`,...(E=(H=g.parameters)==null?void 0:H.docs)==null?void 0:E.source}}};var K,O,B;d.parameters={...d.parameters,docs:{...(K=d.parameters)==null?void 0:K.docs,source:{originalSource:`manyCategoriesStory({
  tileSize: 'small',
  categoryName: 'Livestock',
  categoryDescription: "Cows, pigs and other animals have the potential to dramatically increase farming incomes, but the initial cost can be a barrier. Help farmers invest in their futures.",
  numberLoans: 118,
  ...
  categoryUrl: "/lend-by-category/livestock",
  numberTiles: 3
})`,...(B=(O=d.parameters)==null?void 0:O.docs)==null?void 0:B.source}}};const fe=["Default","Large","Medium","Small","ManyCategories"];export{c as Default,m as Large,d as ManyCategories,l as Medium,g as Small,fe as __namedExportsOrder,ve as default};
