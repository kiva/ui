import{K as e}from"./entry-KvPhoneInput-BWEkYiC4d_.js";import"./entry-index-CQOfz2v5TU.js";import"./entry-vue.esm-bundler-Duz9TGGLcr.js";import"./entry-KvSecondaryNav-Bp1Uuall6y.js";import"./entry-numeral-DJCTM12wUX.js";import"./entry-_commonjsHelpers-Cpj98o6Yn6.js";import"./entry-KvTextInput-Pm5YUpay3x.js";import"./entry-KvFlag-CS4DYWP5vB.js";import"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";const x={title:"Kv/Form Elements/KvPhoneInput",component:e},t=(o,{argTypes:n})=>({props:Object.keys(n),components:{KvPhoneInput:e},data(){return{myCoolPhoneNumber:"828-479-5482"}},template:`
        <div>
    ...
    `}),s=(o,{argTypes:n})=>({props:Object.keys(n),components:{KvPhoneInput:e},data(){return{myCoolPhoneNumber:"(503) 555-55",isValid:!1}},template:`
        <div>
            <component is="style">
                .valid::after {
                    content: 'valid';
    ...
    `,methods:{onValidityChanged(r){console.log(`onValidityChanged: ${r}`),this.isValid=r}}});var p,d,u;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`(args, {
  argTypes
}) => ({
  ...
  template: \`
    ...
    \`
})`,...(f=(_=m.parameters)==null?void 0:_.docs)==null?void 0:f.source}}};var I,V,E;s.parameters={...s.parameters,docs:{...(I=s.parameters)==null?void 0:I.docs,source:{originalSource:`(args, {
  argTypes
}) => ({
  props: Object.keys(argTypes),
  components: {
...
})`,...(E=(V=s.parameters)==null?void 0:V.docs)==null?void 0:E.source}}};const D=["Default","UsingEvents","InitializeWithNonUSNumber","InitializeWithInvalidNumber","InitializeWithNothing","CheckingValidity"];export{s as CheckingValidity,t as Default,l as InitializeWithInvalidNumber,i as InitializeWithNonUSNumber,m as InitializeWithNothing,a as UsingEvents,D as __namedExportsOrder,x as default};
