import{m as M,a as $,r as V,u as P}from"./entry-index-BJUJHBDYUN.js";import{K as O}from"./entry-KvCurrencyInput-ClJLuWpaME.js";import{c as u,b as r,G as T,K as N,F as c,n as i,r as q,o as l,D as I,d as k,a as v,_ as R,w as U,T as D}from"./entry-vue.esm-bundler-Q9GDM36OM6.js";import{_ as E}from"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";import"./entry-numeral-CMfb424cHV.js";import"./entry-_commonjsHelpers-Cpj98o6Yn6.js";import"./entry-KvWideLoanCard-BcPVF-r37T.js";import"./entry-KvTextInput-a4FppCX_5a.js";import"./entry-KvMaterialIcon-zoO3pT-PAH.js";import"./entry-attrs-C2OODjD6EW.js";const _={name:"MultiAmountSelector",components:{KvCurrencyInput:O},emits:["pill-toggled","custom-amount-updated"],props:{id:{type:String,required:!0},options:{type:Array,required:!0,default(){return[{title:"",key:"",disabled:!1}]}},selected:{type:String,default:""},splitPills:{type:Boolean,default:!1},customAmount:{type:Number,default:25},minCustomAmount:{type:Number,default:25},maxCustomAmount:{type:Number,default:1e4}},data(){return{checked:this.selected,customAmountModel:this.customAmount}},setup(){return{v$:P()}},validations(){return{customAmountModel:{required:V,minValue:$(this.minCustomAmount),maxValue:M(this.maxCustomAmount)}}},watch:{customAmount(t,n){t!==n&&(this.customAmountModel=t)},customAmountModel(t){this.$emit("custom-amount-updated",t)},selected(t,n){t==="custom"&&this.$nextTick(()=>{try{this.$refs[`${this.id}-kvCurrencyRef`][0].$refs.kvCurrencyInputRef.focus()}catch{}}),t!=="custom"&&this.v$.$invalid&&(this.customAmountModel=this.minCustomAmount),t!=="custom"&&t!==n&&(this.checked=t)}},methods:{onChange(t){this.$emit("pill-toggled",t)}}},F=["id","disabled","value","onChange"],B=["for"],K={key:0,class:"custom-amount-holder"},j={key:0,class:"validation-errors"},w={key:0};function z(t,n,e,a,s,x){var p,f,y,h;const S=q("kv-currency-input");return l(),u("div",{class:i({"kv-pill-toggle":!0,"split-pills":e.splitPills})},[(l(!0),u(T,null,N(e.options,o=>(l(),u("div",{key:o.key,class:i({pill:!0,"split-pill":e.splitPills})},[I(k("input",{class:"radio",type:"radio",id:`${e.id}-${o.key}`,disabled:o.disabled,value:o.key,"onUpdate:modelValue":n[0]||(n[0]=m=>s.checked=m),onChange:m=>x.onChange(o.key)},null,40,F),[[R,s.checked]]),k("label",{class:i({label:!0,"split-pill-label":e.splitPills}),for:`${e.id}-${o.key}`},c(o.title),11,B),v(D,{name:"kvfade"},{default:U(()=>[e.selected==="custom"&&o.key==="custom"?(l(),u("div",K,[v(S,{id:`${e.id}-custom-amount-input`,ref_for:!0,ref:`${e.id}-kvCurrencyRef`,class:i(["input-element",{"custom-input-element":!0,error:a.v$.$invalid}]),modelValue:s.customAmountModel,"onUpdate:modelValue":n[1]||(n[1]=m=>s.customAmountModel=m),"aria-disabled":!e.selected==="custom",disabled:!e.selected==="custom"},null,8,["id","class","modelValue","aria-disabled","disabled"])])):r("",!0)],void 0),_:2},1024)],2))),128)),a.v$.$invalid?(l(),u("ul",j,[(f=(p=a.v$.customAmountModel)==null?void 0:p.minValue)!=null&&f.$invalid||(h=(y=a.v$.customAmountModel)==null?void 0:y.maxValue)!=null&&h.$invalid?(l(),u("li",w," Enter an amount of $"+c(e.minCustomAmount)+"–$"+c(e.maxCustomAmount),1)):r("",!0)])):r("",!0)],2)}const b=E(_,[["render",z],["__scopeId","data-v-e7b723ab"]]);_.__docgenInfo={displayName:"MultiAmountSelector",exportName:"default",description:"",tags:{},props:[{name:"id",type:{name:"string"},required:!0},{name:"options",type:{name:"array"},required:!0,defaultValue:{func:!1,value:`[
    {
        title: '',
        key: '',
        disabled: false
