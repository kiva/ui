import{d as I}from"./entry-experimentVersion-DPC15KwAMV.js";import{l as E}from"./entry-logReadQueryError-Codcl0QZ_g.js";import{r as P}from"./entry-settingsUtils-B6HCH--cCk.js";import{l as O}from"./entry-logFormatter-DhjghUk5Me.js";import{g as _}from"./entry-numeral-CMfb424cHV.js";const k={kind:"Document",definitions:[{kind:"OperationDefinition",operation:"query",name:{kind:"Name",value:"experimentSetting"},variableDefinitions:[{kind:"VariableDefinition",variable:{kind:"Variable",name:{kind:"Name",value:"key"}},type:{kind:"NonNullType",type:{kind:"NamedType",name:{kind:"Name",value:"String"}}},directives:[]}],directives:[],selectionSet:{kind:"SelectionSet",selections:[{kind:"Field",name:{kind:"Name",value:"general"},arguments:[],directives:[],selectionSet:{kind:"SelectionSet",selections:[{kind:"Field",name:{kind:"Name",value:"uiExperimentSetting"},arguments:[{kind:"Argument",name:{kind:"Name",value:"key"},value:{kind:"Variable",name:{kind:"Name",value:"key"}}}],directives:[],selectionSet:{kind:"SelectionSet",selections:[{kind:"Field",name:{kind:"Name",value:"key"},arguments:[],directives:[]},{kind:"Field",name:{kind:"Name",value:"value"},arguments:[],directives:[]}]}}]}}]}}],loc:{start:0,end:142}};k.loc.source={body:`
	...
	postCheckoutAchievements(loanIds: $loanIds) {
		overallProgress {
            ...
            `,name:"GraphQL request",locationOffset:{line:1,column:1}};const v=(e,i)=>{if(e.kind==="FragmentSpread")i.add(e.name.value);else if(e.kind==="VariableDefinition"){const n=e.type;n.kind==="NamedType"&&i.add(n.name.value)}e.selectionSet&&e.selectionSet.selections.forEach(function(n){v(n,i)}),e.variableDefinitions&&e.variableDefinitions.forEach(function(n){v(n,i)}),e.definitions&&e.definitions.forEach(function(n){v(n,i)})},S={},G=e=>{e.definitions.forEach(function(i){if(i.name){const n=new Set;v(i,n),S[i.name.value]=n}})};G(N);const $=(e,i)=>{for(let n=0;n<e.definitions.length;n++){const s=e.definitions[n];if(s.name&&s.name.value==i)return s}},J=(e,i)=>{const n={kind:e.kind,definitions:[$(e,i)]};e.hasOwnProperty("loc")&&(n.loc=e.loc);const s=S[i]||new Set,c=new Set;let r=new Set;for(s.forEach(t=>{r.add(t)});r.size>0;){const t=r;r=new Set,t.forEach(a=>{c.has(a)||(c.add(a),(S[a]||new Set).forEach(o=>{r.add(o)}))})}return c.forEach(t=>{const a=$(e,t);a&&n.definitions.push(a)}),n};J(N,"PostCheckoutAchievements");const D="myKivaJan2025Exp",A="my_kiva_jan_2025",Y=4,re="general.my_kiva_all_users.value",C="myKivaGuestAssignment",ce="my-kiva-hero-carousel",z=_`
