import{g as S}from"./entry-index-CKVkeXup4D.js";import{p as M}from"./entry-percent-raised-mixin-DA869t-Oxs.js";import{t as U}from"./entry-time-left-mixin-BRu44xUuxu.js";import{F as O}from"./entry-FundraisingStatusMeter-CmeywaLIgC.js";import{K as V}from"./entry-KvLoadingParagraph-CDH0PallEB.js";import{n as F}from"./entry-numeral-BEwyVwpTZh.js";import{d as E}from"./entry-basketItems-BEDWpZvb7f.js";import{K as z}from"./entry-KvButton-Bg6Typ1Yo3.js";import{K as P}from"./entry-KvIcon-B0ZqqslKIC.js";import{K as W}from"./entry-KvLoadingSpinner-BwMDNdkZED.js";import{a as d,H as x,D as u,o as i,f as c,w as k,g as w,E as m,h as l,n as j,d as p,R as G,S as H,e as r,b as v,F as h,J as f}from"./entry-vue.esm-bundler-Bbq66B_iPn.js";import{_ as I}from"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";import{w as R,a as B}from"./entry-exports-B6EYZdgWeI.js";import{w as J,G as X}from"./entry-KvMaterialIcon-Df-hQ8Uinv.js";import"./entry-KvWideLoanCard-M9KpJ2J73i.js";import{_ as Y}from"./entry-KvLoadingPlaceholder-Czw9KhRCOq.js";import{j as Z}from"./entry-KvFlag-CeGYyDoD10.js";const C={name:"LendButton2",inject:["apollo","cookieStore"],props:{loanId:{type:Number,default:null},isInBasket:{type:Boolean,default:!1},isLentTo:{type:Boolean,default:!1},price:{type:[Number,String],default:25}},components:{KvButton:z,KvIcon:P,KvLoadingSpinner:W},data(){return{isAdding:!1}},computed:{state(){return this.isAdding?"adding":this.isInBasket?"basketed":this.isLentTo?"lent-to":"lend"},showLend(){return this.state==="lend"},showLendAgain(){return this.state==="lent-to"},showAdding(){return this.state==="adding"},showCheckout(){return this.state==="basketed"}},methods:{addToBasket(){const e=F(this.price).format("0.00");this.isAdding=!0,this.apollo.mutate({mutation:S`mutation addToBasket($loanId: Int!, $price: Money!, $basketId: String) {
