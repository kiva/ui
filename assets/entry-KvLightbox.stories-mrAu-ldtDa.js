import{K as i}from"./entry-KvLightbox-OvCEfbfIA4.js";import{K as g}from"./entry-KvButton-Bg6Typ1Yo3.js";import"./entry-vue-focus-lock-FafXA7Hhnd.js";import"./entry-vue.esm-bundler-Bbq66B_iPn.js";import"./entry-KvIcon-B3IhT1wUWc.js";import"./iframe-CQC5nSgM.js";import"../sb-preview/runtime.js";import"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";import"./entry-lock-scroll-Bww220JhDP.js";const m=`
    <p>
...
`,t={visible:!0,preventClose:!1,title:"Test Title",inverted:!1,noPaddingTop:!1,noPaddingBottom:!1,noPaddingSides:!1},Q={title:"Kv/KvLightbox",component:i,args:t},n=(o,{argTypes:e})=>({components:{KvLightbox:i},props:Object.keys(e),data:()=>({lightboxVisible:!1}),methods:{showLightbox(){this.lightboxVisible=!0},hideLightbox(){this.lightboxVisible=!1}},setup(){return o},template:`
  ...
  template: \`
    ...
    \`
})`,...(k=(x=s.parameters)==null?void 0:x.docs)==null?void 0:k.source}}};var P,f,q;a.parameters={...a.parameters,docs:{...(P=a.parameters)==null?void 0:P.docs,source:{originalSource:`(args, {
  argTypes
}) => ({
  components: {
    KvLightbox
  ...
  template: \`
    ...
    \`
})`,...(q=(f=a.parameters)==null?void 0:f.docs)==null?void 0:q.source}}};var T,B,S;l.parameters={...l.parameters,docs:{...(T=l.parameters)==null?void 0:T.docs,source:{originalSource:`(args, {
  argTypes
}) => ({
  components: {
    KvLightbox
  ...
  template: \`
    ...
    \`
})`,...(L=(C=r.parameters)==null?void 0:C.docs)==null?void 0:L.source}}};var V,K,I;d.parameters={...d.parameters,docs:{...(V=d.parameters)==null?void 0:V.docs,source:{originalSource:`(_, {
  argTypes
}) => ({
  components: {
    KvLightbox,
  ...
  template: \`
    ...
    \`
})`,...(I=(K=d.parameters)==null?void 0:K.docs)==null?void 0:I.source}}};var O,j,F;u.parameters={...u.parameters,docs:{...(O=u.parameters)==null?void 0:O.docs,source:{originalSource:`(_, {
  argTypes
}) => ({
  components: {
    KvLightbox,
  ...
  template: \`
    ...
    \`
})`,...(F=(j=u.parameters)==null?void 0:j.docs)==null?void 0:F.source}}};var E,_,$;p.parameters={...p.parameters,docs:{...(E=p.parameters)==null?void 0:E.docs,source:{originalSource:`(_, {
  argTypes
}) => ({
  components: {
    KvLightbox
  ...
  template: \`
    ...
    \`
})`,...($=(_=p.parameters)==null?void 0:_.docs)==null?void 0:$.source}}};const z=["Default","Inverted","PreventClose","Padding","SmallContent","WithControls","WithFoundationGrid","CustomTitleColor"];export{p as CustomTitleColor,n as Default,s as Inverted,l as Padding,a as PreventClose,r as SmallContent,d as WithControls,u as WithFoundationGrid,z as __namedExportsOrder,Q as default};
