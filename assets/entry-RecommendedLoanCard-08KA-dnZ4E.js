import{n as D,g as S}from"./entry-numeral-DJCTM12wUX.js";import{p as M,t as U}from"./entry-time-left-mixin-uDnxYTFHu3.js";import{F}from"./entry-FundraisingStatusMeter-igVokgnAMQ.js";import{K as O}from"./entry-KvLoadingParagraph-CaJBrJHkXb.js";import{_ as V}from"./entry-basketItems-AJqL_yrdZS.js";import{_ as E}from"./entry-KvButton-U52zchXZWJ.js";import{K as z}from"./entry-KvIcon-BrNY7gjzFb.js";import{K as P}from"./entry-KvLoadingSpinner-DQ8CSzEZh8.js";import{E as u,f as c,d as l,I as x,b as k,n as W,r as d,o as i,g as w,F as m,a as p,e as r,c as v,G as h,K as f}from"./entry-vue.esm-bundler-DRMQxQJg8r.js";import{_ as I}from"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";import{w as R,a as B}from"./entry-exports-CudK1O5XNw.js";import{F as j}from"./entry-mdi-CMeqivaQKM.js";import{w as G}from"./entry-KvMaterialIcon-Bzq2cnQaw_.js";import"./entry-KvAtbModal-DBQkdQ0mEi.js";import{_ as H}from"./entry-KvLoadingPlaceholder-NKu1_37dc_.js";import{j as J}from"./entry-KvFlag-DLmtikRxUS.js";const C={name:"LendButton2",inject:["apollo","cookieStore"],props:{loanId:{type:Number,default:null},isInBasket:{type:Boolean,default:!1},isLentTo:{type:Boolean,default:!1},price:{type:[Number,String],default:25}},components:{KvButton:E,KvIcon:z,KvLoadingSpinner:P},data(){return{isAdding:!1}},computed:{state(){return this.isAdding?"adding":this.isInBasket?"basketed":this.isLentTo?"lent-to":"lend"},showLend(){return this.state==="lend"},showLendAgain(){return this.state==="lent-to"},showAdding(){return this.state==="adding"},showCheckout(){return this.state==="basketed"}},methods:{addToBasket(){const e=D(this.price).format("0.00");this.isAdding=!0,this.apollo.mutate({mutation:S`mutation addToBasket($loanId: Int!, $price: Money!, $basketId: String) {
