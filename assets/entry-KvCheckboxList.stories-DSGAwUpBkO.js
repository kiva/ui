import{c as o,b as E,t as f,g as N,F as B,d as F,r as O,o as c,a as T,f as q,h as I}from"./entry-vue.esm-bundler-Du63x9n7zJ.js";import"./entry-KvWwwHeaderBasic-DMkxmXVWpl.js";import"./entry-tailwind.config-DnDN25xoV6.js";import{E as U}from"./entry-KvCheckbox-DXfkQ4xkwx.js";import"./entry-numeral-xVHG5DEP0A.js";import{_ as W}from"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";import"./entry-index-CWclSTHHJk.js";import"./entry-index-CovN8vffBz.js";import"./entry-index-DaZG7dZWP2.js";import"./entry-index-jQMUY8qRYX.js";import"./iframe-LCVN7OV2.js";import"./entry-_commonjsHelpers-Cpj98o6Yn6.js";import"./entry-index.browser-vcSNLBTfP4.js";const K={name:"KvCheckboxList",components:{KvCheckbox:U},emits:["updated"],props:{showSelectAll:{type:Boolean,default:!1},items:{type:Array,required:!0},selectedValues:{type:Array,default:()=>[]}},data(){return{selected:this.selectedValues}},computed:{isAllSelected(){return this.items.every(t=>this.selected.includes(t.value))}},methods:{toggleSelectAll(){const t=this.isAllSelected,e=[...this.selected];this.items.forEach(s=>{const m=e.indexOf(s.value),a=m!==-1;t?a&&e.splice(m,1):a||e.push(s.value)}),this.selected=e,this.updateSelected(e,void 0,!0)},updateSelected(t,e,s){this.$emit("updated",{values:[...t],changed:e,wasSelectAll:s})}},watch:{selectedValues(t){[...t].sort().toString()!==[...this.selected].sort().toString()&&(this.selected=t)}}},$={class:"tw-flex tw-flex-col tw-gap-1.5 tw-my-.5 tw-mb-1"},j={key:0};function z(t,e,s,m,a,p){const L=O("kv-checkbox");return c(),o("menu",$,[s.showSelectAll?(c(),o("li",j,[E("button",{class:"tw-text-link",onClick:e[0]||(e[0]=l=>p.toggleSelectAll())},f(p.isAllSelected?"Deselect":"Select")+" all ",1)])):N("",!0),(c(!0),o(B,null,F(s.items,(l,D)=>(c(),o("li",{key:D},[T(L,{value:l.value,disabled:l.disabled,modelValue:a.selected,"onUpdate:modelValue":e[1]||(e[1]=h=>a.selected=h),onChange:h=>p.updateSelected(h,l.value)},{default:q(()=>[I(f(l.title),1)],void 0),_:2},1032,["value","disabled","modelValue","onChange"])]))),128))])}const G=W(K,[["render",z]]);K.__docgenInfo={displayName:"KvCheckboxList",exportName:"default",description:"",tags:{},props:[{name:"showSelectAll",description:"Whether to show the select/deselect all link",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"items",description:`The items to display in the checkbox list
