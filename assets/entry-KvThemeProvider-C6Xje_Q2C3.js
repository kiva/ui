import{c as t,g as o,L as i,o as a}from"./entry-vue.esm-bundler-CCMUuEADRp.js";import{_ as s}from"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";const e={props:{theme:{type:Object,default:null}}};function d(n,m,r,l,h,c){return a(),t("div",{style:i({...r.theme,color:"rgb(var(--text-primary))"})},[o(n.$slots,"default")],4)}const u=s(e,[["render",d]]);e.__docgenInfo={description:`A wrapper component that sets CSS custom properties to theme its children.
...
\`\`\``,title:"usage"}]},type:{name:"object"},defaultValue:{func:!1,value:"null"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/ui/ui/node_modules/@kiva/kv-components/vue/KvThemeProvider.vue"]};export{u as K};
