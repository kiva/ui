import{K as F}from"./entry-KvResponsiveImage-oaSHk5p5t_.js";import{c as y,D as v,f as b,w as k,h as _,r as S,N as G,o as n,a as I,e as t,I as r,n as P}from"./entry-vue.esm-bundler-CCMUuEADRp.js";import{_ as q}from"./entry-_plugin-vue_export-helper-DlAUqK2UKH.js";import{K as B}from"./entry-KvGrid-CI1zEoosXE.js";import{K as R}from"./entry-KvPageContainer-BzJOlwVIil.js";import"./entry-throttle-C_gUPZjI8B.js";import"./entry-_commonjsHelpers-BosuxZz1dT.js";import"./entry-isSymbol-Cs2hrTnPnb.js";import"./entry-toNumber-BfkLXMgxIK.js";const W={name:"MainCategoryTile",props:{tileSize:{type:String,default:"small",validator:a=>["small","medium","large"].indexOf(a)!==-1},categoryName:{type:String,default:""},categoryDescription:{type:String,default:""},numberLoans:{type:Number,default:0},image:{type:String,default:""},retinaImage:{type:String,default:""},categoryUrl:{type:String,default:""}},components:{KvResponsiveImage:F},data(){return{}},computed:{retinaImageExists(){return this.retinaImage!==""},altText(){return`Kiva loans to ${this.categoryName}`},cleanURL(){return this.categoryUrl.substring(this.categoryUrl.lastIndexOf("/")+1)}},methods:{chooseImage(a){return a==="large"?this.retinaImageExists?[["small",this.retinaImage],["small retina",this.retinaImage]]:[["small",this.image]]:a==="medium"?this.retinaImageExists?[["small",this.retinaImage],["small retina",this.retinaImage],["large",this.image],["large retina",this.retinaImage]]:[["small",this.image]]:this.retinaImageExists?[["small",this.image],["small retina",this.retinaImage]]:[["small",this.image]]}}},A={key:0,class:"tw-mb-6 tw-group","data-testid":"all-categories-tiles"},J={class:"tw-text-center tw-flex tw-justify-between"},Q={class:"tw-mt-2 tw-mb-2 group-hover:tw-underline"},X={class:"tw-line-clamp-3"},Y={key:0,class:"tw-mt-1 tw-mb-2 tw-hidden md:tw-block"},Z={key:1,class:"tw-mb-6 tw-group","data-testid":"all-categories-tiles"},$={class:"tw-flex"},ee={class:"tw-mr-2 tw-flex-none"},te={class:"tw-grow"},ae={class:"tw-mb-2 group-hover:tw-underline"},re={class:"tw-line-clamp-2"},ie={class:"tw-mt-1 tw-mb-1"};function se(a,i,e,o,oe,s){const p=S("kv-responsive-image"),w=S("router-link"),f=G("kv-track-event");return e.tileSize==="large"||e.tileSize==="medium"?(n(),y("div",A,[v((n(),b(w,{class:"remove-link-decoration",to:`/lend-by-category/${s.cleanURL}`},{default:k(()=>[I(p,{class:"category-image category-image__large",images:s.chooseImage(e.tileSize),loading:"lazy",alt:s.altText},null,8,["images","alt"]),t("div",null,[t("div",J,[t("h3",Q,r(e.categoryName),1),t("h4",{class:P(["tw-mt-2 tw-mb-2",e.tileSize==="medium"?"md:tw-hidden":""])},r(e.numberLoans)+" loans ",3)]),t("div",null,[t("p",X,r(e.categoryDescription),1)])]),e.tileSize==="medium"?(n(),y("h4",Y,r(e.numberLoans)+" loans ",1)):_("",!0)],void 0),_:1},8,["to"])),[[f,["Lending","click-Category",e.categoryName]]])])):e.tileSize==="small"?(n(),y("div",Z,[v((n(),b(w,{class:"remove-link-decoration",to:`/lend-by-category/${s.cleanURL}`},{default:k(()=>[t("div",$,[t("div",ee,[I(p,{class:"category-image category-image__small",images:s.chooseImage(e.tileSize),loading:"lazy",alt:s.altText},null,8,["images","alt"])]),t("div",te,[t("h3",ae,r(e.categoryName),1),t("div",null,[t("span",re,r(e.categoryDescription),1)]),t("h4",ie,r(e.numberLoans)+" loans ",1)])])],void 0),_:1},8,["to"])),[[f,["Lending","click-Category",e.categoryName]]])])):_("",!0)}const h=q(W,[["render",se],["__scopeId","data-v-59219025"]]);W.__docgenInfo={displayName:"MainCategoryTile",exportName:"default",description:"",tags:{},props:[{name:"tileSize",type:{name:"string"},defaultValue:{func:!1,value:"'small'"}},{name:"categoryName",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"categoryDescription",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"numberLoans",type:{name:"number"},defaultValue:{func:!1,value:"0"}},{name:"image",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"retinaImage",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"categoryUrl",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],sourceFiles:["/home/runner/work/ui/ui/src/components/Categories/MainCategoryTile.vue"]};const we={title:"Components/Main Category Tile",component:h,args:{tileSize:"small",numberTiles:3},argTypes:{tileSize:{control:{type:"select"},options:["small","medium","large"]}}},u=(a={})=>{const i=(e,{argTypes:o})=>({props:Object.keys(o),components:{MainCategoryTile:h,KvGrid:B,KvPageContainer:R},setup(){return a},template:`
            <kv-page-container>
        ...
        `});return i.args=a,i},ne=(a={})=>{const i=(e,{argTypes:o})=>({props:Object.keys(o),components:{MainCategoryTile:h,KvGrid:B,KvPageContainer:R},setup(){return a},template:`
            <kv-page-container>
                <kv-grid class="tw-grid-cols-12">
...
})`,...(z=(N=l.parameters)==null?void 0:N.docs)==null?void 0:z.source}}};var D,j,C;c.parameters={...c.parameters,docs:{...(D=c.parameters)==null?void 0:D.docs,source:{originalSource:`story({
  tileSize: 'large',
  categoryName: 'Women',
...
})`,...(C=(j=c.parameters)==null?void 0:j.docs)==null?void 0:C.source}}};var x,U,T;m.parameters={...m.parameters,docs:{...(x=m.parameters)==null?void 0:x.docs,source:{originalSource:`story({
  tileSize: 'medium',
  ...
  categoryUrl: "/lend-by-category/livestock",
  numberTiles: 3
})`,...(O=(E=d.parameters)==null?void 0:E.docs)==null?void 0:O.source}}};const fe=["Default","Large","Medium","Small","ManyCategories"];export{l as Default,c as Large,d as ManyCategories,m as Medium,g as Small,fe as __namedExportsOrder,we as default};
