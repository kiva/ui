...
module.exports = merge(base, {
	app: {
		...
		auth0: {
			...
			enableAuth0: false,
			auth0ApiAudience: 'https://api.qa.kivaws.org/graphql',
			auth0BrowserClientID: 'D4nisXFEuifQ8Am1WoJJpuneCBTBle3Q',
			auth0ServerClientID: 'tZuDW6xKBP5WYgP8FEwNsl41T4fhjWhF',
