...
module.exports = merge(base, {
	app: {
		...
		auth0: {
			loginRedirectUrls: {
				...
				tZuDW6xKBP5WYgP8FEwNsl41T4fhjWhF: 'https://www.qa.kiva.org/ui-login',
				D4nisXFEuifQ8Am1WoJJpuneCBTBle3Q: 'https://www.qa.kiva.org/ui-login',
			},
			enable: true,
	...
	server: {
		...
		memcachedServers: 'qa-memcached-01:11211',
	}
})
