...
module.exports = merge(base, {
	app: {
		...
		auth0: {
			loginRedirectUrls: {
				A4914FJRPa71OPMzR0T106GPxVHH3q5c: 'https://admin.audit.kiva.org/login',
				aXEO12lKmGd1qSDMb0V6QYMbb40He8Wd: 'https://partners.audit.kiva.org/login',
				lLGHlyn6iT1uzE0tbWQaoLcjdDe5u1Po: 'https://www.audit.kiva.org/authenticate',
				'372Ui67a51VX4AcSq9FjUOuQD3dfKNUt': 'https://www.audit.kiva.org/ui-login',
				Pc96rp0vzWOcAlWk5HJTozjTTP6qZyDP: 'https://www.audit.kiva.org/ui-login',
			},
			enable: true,
