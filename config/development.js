...
module.exports = merge(base, {
	app: {
		...
		auth0: {
			loginRedirectUrls: {
				cNTV7eN5sBKgv9nQOxDpAz1pPfJGlBI5: 'https://admin.development.kiva.org/admin/login?force=1',
				e6wSaTBDpKRkV5SV5cWw6zD6eJjd2DEk: 'https://partners.development.kiva.org/pa2/login/login?authLevel=recent',
				xOXldYg02WsLnlnn0D5xoPWI2i3aNsFD: 'https://www.development.kiva.org/authenticate?authLevel=recent',
				KIzjUBQjKZwMRgYSn6NvMxsUwNppwnLH: 'https://www.development.kiva.org/ui-login?force=true',
				ouGKxT4mE4wQEKqpfsHSE96c9rHXQqZF: 'https://www.development.kiva.org/ui-login?force=true',
			},
			enable: true,
			checkFakeAuth: true,
			...
			browserCallbackUri: 'https://www.development.kiva.org/process-browser-auth',
			serverCallbackUri: 'https://www.development.kiva.org/process-ssr-auth',
