...
module.exports = merge(base, {
	app: {
		...
		auth0: {
			loginRedirectUrls: {
				cNTV7eN5sBKgv9nQOxDpAz1pPfJGlBI5: 'https://admin.test.kiva.org/login',
				e6wSaTBDpKRkV5SV5cWw6zD6eJjd2DEk: 'https://partners.test.kiva.org/login',
				xOXldYg02WsLnlnn0D5xoPWI2i3aNsFD: 'https://www.test.kiva.org/authenticate',
				KIzjUBQjKZwMRgYSn6NvMxsUwNppwnLH: 'https://www.test.kiva.org/ui-login',
				ouGKxT4mE4wQEKqpfsHSE96c9rHXQqZF: 'https://www.test.kiva.org/ui-login',
			},
			enable: true,
