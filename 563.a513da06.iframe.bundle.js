...
/* harmony default export */ var CenteredRichTextvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    richContent: function richContent() {
      var _this$content2, _this$content2$conten, _richContent$richText;

      var richContent = (_this$content2 = this.content) === null || _this$content2 === void 0 ? void 0 : (_this$content2$conten = _this$content2.contents) === null || _this$content2$conten === void 0 ? void 0 : _this$content2$conten.find(function (_ref2) {
