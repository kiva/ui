...
var KivaClassicLoanCarousel = __webpack_require__(940);
...
/* harmony default export */ var KivaClassicLoanCategorySelectorvue_type_script_lang_js_ = ({
  ...
  methods: {
    handleCategoryClick: function handleCategoryClick(category) {
      ...
      var categoryShortName = (_category$shortName = category === null || category === void 0 ? void 0 : category.shortName) !== null && _category$shortName !== void 0 ? _category$shortName : '';
  ...
  methods: {
    ...
    fetchLoanChannel: function fetchLoanChannel() {
      ...
      this.apollo.query({
        ...
        var loanChannels = (_result$data$lend$loa = result === null || result === void 0 || (_result$data = result.data) === null || _result$data === void 0 || (_result$data = _result$data.lend) === null || _result$data === void 0 ? void 0 : _result$data.loanChannelsById) !== null && _result$data$lend$loa !== void 0 ? _result$data$lend$loa : [];
        _this3.loanChannelData = loanChannels;
        // Activate the first channel available
        var initialChannel = _this3.combinedLoanChannelData[0];
        _this3.selectedChannel = initialChannel;
  ...
  computed: {
    ...
    * */
    contentfulLoanChannels: function contentfulLoanChannels() {
      var _this$content2, _uiSetting$dataObject, _uiSetting$dataObject2;
      var uiSetting = (_this$content2 = this.content) === null || _this$content2 === void 0 || (_this$content2 = _this$content2.contents) === null || _this$content2 === void 0 ? void 0 : _this$content2.find(function (_ref2) {
    ...
    * */
    loanDisplaySettings: function loanDisplaySettings() {
      var _this$content3, _uiSetting$dataObject3, _uiSetting$dataObject4, _uiSetting$dataObject5, _uiSetting$dataObject6;
      var uiSetting = (_this$content3 = this.content) === null || _this$content3 === void 0 || (_this$content3 = _this$content3.contents) === null || _this$content3 === void 0 ? void 0 : _this$content3.find(function (_ref3) {
