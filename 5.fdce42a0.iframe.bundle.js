...
// load the styles
var content = __webpack_require__(5780);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__(12).default
var update = add("2c5b9006", content, true, {});
...
// load the styles
var content = __webpack_require__(5782);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
...
"use strict";
/* harmony import */ var _node_modules_vue_docgen_loader_lib_index_js_node_modules_thread_loader_dist_cjs_js_ref_7_0_node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_7_4_node_modules_vue_loader_lib_index_js_vue_loader_options_BraintreeDropInInterface_vue_vue_type_style_index_0_id_39c005cf_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5464);
/* harmony import */ var _node_modules_vue_docgen_loader_lib_index_js_node_modules_thread_loader_dist_cjs_js_ref_7_0_node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_7_4_node_modules_vue_loader_lib_index_js_vue_loader_options_BraintreeDropInInterface_vue_vue_type_style_index_0_id_39c005cf_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_docgen_loader_lib_index_js_node_modules_thread_loader_dist_cjs_js_ref_7_0_node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_7_4_node_modules_vue_loader_lib_index_js_vue_loader_options_BraintreeDropInInterface_vue_vue_type_style_index_0_id_39c005cf_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "#dropin-container[data-v-39c005cf]  .braintree-dropin{font-family:inherit}#dropin-container[data-v-39c005cf]  [data-braintree-id=sheet-error]{background-color:#fff}#dropin-container[data-v-39c005cf]  .braintree-method .braintree-method__label .braintree-method__label--small,#dropin-container[data-v-39c005cf]  .braintree-method__label,#dropin-container[data-v-39c005cf]  .braintree-methods--active .braintree-method__label,#dropin-container[data-v-39c005cf]  .braintree-option__label{color:#212121;font-weight:300;text-align:left}#dropin-container[data-v-39c005cf]  [data-braintree-id=methods-container] .braintree-method--active{background-color:#fafafa;border-color:#4faf4e;border-width:1px}#dropin-container[data-v-39c005cf]  [data-braintree-id=methods-container] .braintree-method__check{background-color:#4faf4e;height:1.95rem;margin-right:.25rem;padding:.3125rem;width:1.95rem}#dropin-container[data-v-39c005cf]  [data-braintree-id=applePay],#dropin-container[data-v-39c005cf]  [data-braintree-id=card],#dropin-container[data-v-39c005cf]  [data-braintree-id=googlePay],#dropin-container[data-v-39c005cf]  [data-braintree-id=paypal]{border:0}#dropin-container[data-v-39c005cf]  [data-braintree-id=card] .braintree-sheet__content.braintree-sheet__content--form{padding:0}#dropin-container[data-v-39c005cf]  [data-braintree-id=card] .braintree-sheet__content .braintree-form__field-error{color:#d74937;font-weight:400;text-align:left}#dropin-container[data-v-39c005cf]  [data-braintree-id=card] .braintree-sheet__content .braintree-form__field-group{margin-bottom:1.25rem;padding-left:0}#dropin-container[data-v-39c005cf]  [data-braintree-id=card] .braintree-sheet__content .braintree-form__field-group.braintree-form__field-group--has-error .braintree-form__hosted-field{background-color:rgba(215,73,55,.15);border-color:#d74937;border-radius:.25rem}#dropin-container[data-v-39c005cf]  [data-braintree-id=card] .braintree-sheet__content .braintree-form__field-group:not(.braintree-form__field-group--has-error) .braintree-form__field:not(.braintree-form__checkbox) .braintree-form__hosted-field{background-color:#fafafa;border-color:#757575;border-radius:.25rem;color:#9d9c9e}#dropin-container[data-v-39c005cf]  [data-braintree-id=card] .braintree-sheet__content span.braintree-form__descriptor{display:none}#dropin-container[data-v-39c005cf]  [data-braintree-id=card] .braintree-sheet__content [data-braintree-id=cvv-field-group],#dropin-container[data-v-39c005cf]  [data-braintree-id=card] .braintree-sheet__content [data-braintree-id=expiration-date-field-group],#dropin-container[data-v-39c005cf]  [data-braintree-id=card] .braintree-sheet__content [data-braintree-id=postal-code-field-group]{-ms-flex-preferred-size:auto;-webkit-box-flex:unset;-ms-flex-positive:unset;flex-basis:auto;flex-grow:unset;width:49%}#dropin-container[data-v-39c005cf]  [data-braintree-id=card-view-icons]{padding-bottom:0}#dropin-container[data-v-39c005cf]  [data-braintree-id=card-view-icons]>div{border:1px solid #f3f3f3;border-radius:.25rem;line-height:.6875rem;padding:0}#dropin-container[data-v-39c005cf]  [data-braintree-id=paypal-button]{width:99%}@media print,screen and (min-width:30.0625em){#dropin-container[data-v-39c005cf]  [data-braintree-id=paypal-button]{width:250px}}#dropin-container[data-v-39c005cf]  [data-braintree-id=number-field-group]:not(.braintree-form__field-group--card-type-known) svg{display:none}#dropin-container[data-v-39c005cf]  iframe[type=number]{background-color:transparent;-webkit-box-shadow:none;box-shadow:none;padding:0}#payment-updating-overlay[data-v-39c005cf]{background-color:rgba(255,255,255,.7);z-index:500}.drop-in-wrapper[data-v-39c005cf]{text-align:center}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/vue-docgen-loader/lib!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Payment/BraintreeDropInInterface.vue?vue&type=template&id=39c005cf&scoped=true&
...
// CONCATENATED MODULE: ./src/components/Payment/BraintreeDropInInterface.vue?vue&type=template&id=39c005cf&scoped=true&
...
var esm_exports = __webpack_require__(1454);

// EXTERNAL MODULE: ./src/graphql/query/checkout/getClientToken.graphql
var getClientToken_graphql = __webpack_require__(5778);
  ...
  watch: {
    ...
    amount: {
      handler: function handler(next, prev) {
        if (next !== prev) {
          var _this$btDropinInstanc, _this$btDropinInstanc2, _this$btDropinInstanc3, _this$btDropinInstanc4, _this$btDropinInstanc5, _this$btDropinInstanc6, _this$btDropinInstanc7, _this$btDropinInstanc8;
          ...
          (_this$btDropinInstanc3 = this.btDropinInstance) === null || _this$btDropinInstanc3 === void 0 || (_this$btDropinInstanc4 = _this$btDropinInstanc3.updateConfiguration) === null || _this$btDropinInstanc4 === void 0 || _this$btDropinInstanc4.call(_this$btDropinInstanc3, 'paypalCredit', 'amount', this.formattedAmount);
          (_this$btDropinInstanc5 = this.btDropinInstance) === null || _this$btDropinInstanc5 === void 0 || (_this$btDropinInstanc6 = _this$btDropinInstanc5.updateConfiguration) === null || _this$btDropinInstanc6 === void 0 || _this$btDropinInstanc6.call(_this$btDropinInstanc5, 'googlePay', 'transactionInfo', this.googleTransactionInfo);
          (_this$btDropinInstanc7 = this.btDropinInstance) === null || _this$btDropinInstanc7 === void 0 || (_this$btDropinInstanc8 = _this$btDropinInstanc7.updateConfiguration) === null || _this$btDropinInstanc8 === void 0 || _this$btDropinInstanc8.call(_this$btDropinInstanc7, 'applePay', 'paymentRequest', this.applePaymentRequest);
        }
      },
      immediate: true
    }
      ...
      return asyncToGenerator_default()( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return __webpack_require__.e(/* import() */ 9).then(__webpack_require__.t.bind(null, 5885, 7));
            case 2:
...
// EXTERNAL MODULE: ./src/components/Payment/BraintreeDropInInterface.vue?vue&type=style&index=0&id=39c005cf&lang=scss&scoped=true&
var BraintreeDropInInterfacevue_type_style_index_0_id_39c005cf_lang_scss_scoped_true_ = __webpack_require__(5779);

// EXTERNAL MODULE: ./src/components/Payment/BraintreeDropInInterface.vue?vue&type=style&index=1&lang=postcss&
var BraintreeDropInInterfacevue_type_style_index_1_lang_postcss_ = __webpack_require__(5781);
