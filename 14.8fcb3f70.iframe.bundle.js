...
// load the styles
var content = __webpack_require__(5599);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
...
// load the styles
var content = __webpack_require__(5601);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
...
// load the styles
var content = __webpack_require__(5603);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
...
/***/ (function(module, exports, __webpack_require__) {
  ...
  doc.definitions = doc.definitions.concat(unique(__webpack_require__(432).definitions));
...
// load the styles
var content = __webpack_require__(5607);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
...
var KvProgressBar = __webpack_require__(294);
...
/* harmony default export */ var CampaignProgressBarvue_type_script_lang_js_ = ({
  ...
  computed: {
    campaignPartnerName: function campaignPartnerName() {
      var _this$promoData$promo, _this$promoData, _this$promoData$promo2;
      ...
      return (_this$promoData$promo = (_this$promoData = this.promoData) === null || _this$promoData === void 0 ? void 0 : (_this$promoData$promo2 = _this$promoData.promoFund) === null || _this$promoData$promo2 === void 0 ? void 0 : _this$promoData$promo2.displayName) !== null && _this$promoData$promo !== void 0 ? _this$promoData$promo : null;
    },
...
var isEqual = __webpack_require__(1029);
...
var KvCheckbox = __webpack_require__(329);
...
var CheckListvue_type_style_index_0_id_6eb5c59b_lang_scss_scoped_true_ = __webpack_require__(5594);
...
/* harmony default export */ var AttributeFiltervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    changeAttributes: function changeAttributes(attributes) {
      ...
      this.currentAttributeIds = attributeIds; // Get list of Attribute Names for loan query
...
var AttributeFiltervue_type_style_index_0_id_81bb1450_lang_scss_scoped_true_ = __webpack_require__(5596);
...
var KvRadio = __webpack_require__(510);
...
/* harmony default export */ var LocationFiltervue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    regions: function regions() {
      var groupedRegions = groupBy_default()(this.countriesWithSelected, 'region'); // alphabetize countries within each region
...
var LocationFiltervue_type_style_index_0_id_f9a51932_lang_scss_scoped_true_ = __webpack_require__(5598);
...
var SectorFiltervue_type_style_index_0_id_8c982670_lang_scss_scoped_true_ = __webpack_require__(5600);
...
var TagFiltervue_type_style_index_0_id_9992d8b6_lang_scss_scoped_true_ = __webpack_require__(5602);
...
var KvChipClassic = __webpack_require__(2377);
...
var KvAccordionItem = __webpack_require__(5731);
...
var filterOptionsQuery = Object(lib["a" /* gql */])(_templateObject || (_templateObject = taggedTemplateLiteral_default()(["\n\tquery filterOptionsQuery {\n\t\tlend {\n\t\t\tcountryFacets {\n\t\t\t\tcountry {\n\t\t\t\t\tisoCode\n\t\t\t\t\tname\n\t\t\t\t\tnumLoansFundraising\n\t\t\t\t\tregion\n\t\t\t\t}\n\t\t\t}\n\t\t\tloanThemeFilter {\n\t\t\t\tid\n\t\t\t\tname\n\t\t\t}\n\t\t\tsector {\n\t\t\t\tid\n\t\t\t\tname\n\t\t\t}\n\t\t\ttag {\n\t\t\t\tid\n\t\t\t\tname\n\t\t\t\tvocabularyId\n\t\t\t}\n\t\t}\n\t}\n"])));
/* harmony default export */ var LoanSearchFiltersvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      ...
      mdiChevronDown: mdi["o" /* mdiChevronDown */],
      mdiGridLarge: mdi["y" /* mdiGridLarge */],
      mdiLandRowsHorizontal: mdi["D" /* mdiLandRowsHorizontal */]
    };
  },
  ...
  watch: {
    initialFilters: {
      handler: function handler() {
        ...
        this.initialFiltersCopy = this.copyFilters(this.initialFilters); // establish non-reactive copy ready for modification
    ...
    copyFilters: function copyFilters(initialFilters) {
      ...
      initialFilterKeys.forEach(function (key) {
        ...
        if (typeof_default()(initialFilters[key]) === 'object' && initialFilters[key] && initialFilters[key] === 'undefined') {
          filtersCopy[key] = _objectSpread({}, initialFilters[key]); // copy an array
        } else if (typeof_default()(initialFilters[key]) === 'object' && initialFilters[key] && initialFilters[key].length) {
          filtersCopy[key] = initialFilters[key].slice(); // copy a string
        } else if (typeof initialFilters[key] === 'string') {
          filtersCopy[key] = initialFilters[key].toString(); // copy a boolean
        } else if (typeof initialFilters[key] === 'boolean') {
          filtersCopy[key] = Boolean(initialFilters[key]); // handle undefined defaults
        } else if (typeof initialFilters[key] === 'undefined') {
          filtersCopy[key] = undefined; // handle null defaults and all others
        } else {
...
var LoanSearchFiltersvue_type_style_index_0_id_c4e22d56_lang_scss_scoped_true_ = __webpack_require__(5604);
...
var basicLoanData_graphql = __webpack_require__(5309);
...
var KivaClassicBasicLoanCard = __webpack_require__(516);
...
/* harmony default export */ var CampaignLoanRowvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    singleSlideWidth: function singleSlideWidth() {
      var viewportWidth = typeof window !== 'undefined' ? window.innerWidth : 1024; // handle tiny screens
  ...
  watch: {
    ...
    filters: function filters(next) {
      ...
      // reset offset
      this.offset = 0; // reset loans

      this.loans = []; // reset loan added flag

      this.loanAdded = false;
      this.loanQueryFilters = next; // Reset carousel position after applying loan filters
  ...
  methods: {
    ...
    fetchLoans: function fetchLoans() {
      ...
      this.apollo.query({
        ...
        var _data$lend$loans$valu, _data$lend, _data$lend$loans;

        var data = _ref.data;
        var newLoans = (_data$lend$loans$valu = (_data$lend = data.lend) === null || _data$lend === void 0 ? void 0 : (_data$lend$loans = _data$lend.loans) === null || _data$lend$loans === void 0 ? void 0 : _data$lend$loans.values) !== null && _data$lend$loans$valu !== void 0 ? _data$lend$loans$valu : []; // Handle appending new loans to carousel
        ...
        if (_this2.isVisible) {
          var _data$lend$loans$tota, _data$lend2, _data$lend2$loans, _data$lend3;

          _this2.totalCount = (_data$lend$loans$tota = (_data$lend2 = data.lend) === null || _data$lend2 === void 0 ? void 0 : (_data$lend2$loans = _data$lend2.loans) === null || _data$lend2$loans === void 0 ? void 0 : _data$lend2$loans.totalCount) !== null && _data$lend$loans$tota !== void 0 ? _data$lend$loans$tota : 0;
    ...
    getAmountLended: function getAmountLended(loanId) {
      if (this.basketLoans.length > 0) {
        var _this$basketLoans, _this$basketLoans$fin;

        return (_this$basketLoans = this.basketLoans) === null || _this$basketLoans === void 0 ? void 0 : (_this$basketLoans$fin = _this$basketLoans.find(function (loan) {
          return String(loan.id) === String(loanId);
        })) === null || _this$basketLoans$fin === void 0 ? void 0 : _this$basketLoans$fin.price;
      }
    }
  }
});
...
var CampaignLoanRowvue_type_style_index_0_id_0d07c292_lang_scss_scoped_true_ = __webpack_require__(5606);
...
var invokeMap = __webpack_require__(5608);
...
function CampaignLoanGridDisplayvue_type_script_lang_js_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function CampaignLoanGridDisplayvue_type_script_lang_js_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { CampaignLoanGridDisplayvue_type_script_lang_js_ownKeys(Object(source), true).forEach(function (key) { defineProperty_default()(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { CampaignLoanGridDisplayvue_type_script_lang_js_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
var loansPerPage = 9; // A map of functions to transform url query parameters to/from graphql variables.
  ...
  methods: {
    ...
    fetchLoans: function fetchLoans() {
      ...
      this.apollo.query({
        ...
        var _data$lend$loans$valu, _data$lend, _data$lend$loans, _data$lend$loans$tota, _data$lend2, _data$lend2$loans;

        var data = _ref4.data;
        _this.loans = (_data$lend$loans$valu = (_data$lend = data.lend) === null || _data$lend === void 0 ? void 0 : (_data$lend$loans = _data$lend.loans) === null || _data$lend$loans === void 0 ? void 0 : _data$lend$loans.values) !== null && _data$lend$loans$valu !== void 0 ? _data$lend$loans$valu : [];
        _this.totalCount = (_data$lend$loans$tota = (_data$lend2 = data.lend) === null || _data$lend2 === void 0 ? void 0 : (_data$lend2$loans = _data$lend2.loans) === null || _data$lend2$loans === void 0 ? void 0 : _data$lend2$loans.totalCount) !== null && _data$lend$loans$tota !== void 0 ? _data$lend$loans$tota : 0;
...
var CampaignLoanGridDisplayvue_type_style_index_0_id_bfb8642a_lang_scss_scoped_true_ = __webpack_require__(5624);
